...
class ContractShell extends Shell
{
    ...
    {
		// $email_subject = "Test mail from cloud contract shell";
		// $email_message = "This is the test message from cloud contract shell so please ignore it.";
		...
		// $email->from("das@gmail.com")
				...
				// ->send($email_message);
		// die;
		$erp_notification = TableRegistry::get('erp_contract_notification');
		...
		$role = ['erphead','ceo','md','financemanager'];
		$emails = array();
	...
	if(!empty($notification_data)){
		foreach($notification_data as $notification)
		{
			...
			{
				$project_data = $erp_projects->get($notification['project_id']);
				$project_name = !empty($project_data)?$project_data['project_name']:"";
				$project_code = !empty($project_data)?$project_data['project_code']:"";
			}else{
				$project_name = "";
				$project_code = "";
			}
			...
			$email_subject = "YashNand: Tender/Contract Notification"; // The Subject of the email  
			$email_message = "Sir,<br>";
			$email_message .= "<p>Please find Tender/Contract Notification details mentioned below. Please check and take necessary actions.</p>";
			$email_message .= "<p><strong>Project Code :</strong> {$project_code}.</p>";
			$email_message .= "<p><strong>Project Name :</strong> {$project_name}. </p><br><br>";
			...
			$email_message .= "<p><strong>E-mail ID: </strong><a href='mailto:info@yashnandeng.com'>info@yashnandeng.com</a></p>";
			$email_message .= "---------------------------------------------------------------------------------------------------------------";
