<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="Assets.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>Assets Records</b></td>");
		...
		unset($rows[0]);
		$header = array("Asset Group","Asset ID","Asset Name","Capacity","Make","Identity/Veh.No","Current Operational Status","Currently Deployed To","Currently Issued To","Tentative Date of Release");
