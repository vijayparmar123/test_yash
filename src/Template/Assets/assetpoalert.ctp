...
?>
	...
	<div class="col-md-12">
		<div class="block" id="pr-div" style="<?php
		 echo (isset($_REQUEST['go']))?'width:auto':''; ?>">
...
?>
				<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					<div class="form-row">					
						...
						<div class="col-md-3">
						 ...
						 <!--<div class="col-md-3">
							<select class="select2"  style="width: 100%;" name="po_type" id="po_type" class="validate[required]">
								<option value="">All</Option>
			...
			echo $this->Form->Create('form2',['id'=>'app_frm','method'=>'post','url'=>['controller'=>"Assets",'action'=>'showinassetporecords']]);
			?>
			...
			<table id="pr_list"  class="table table-bordered table-striped table-hover">
					...
					<tr>
						...
						<th colspan="9" style="padding:0;">
							<table class='table-bordered' style='width:100%;'>
								...
								<th>Edit/View</th>
								<?php
								if($this->ERPfunction->retrive_accessrights($role,'verifyassetpoalert')==1)
								{
								?>
								<th>Verify</th>
								<?php
								}
								if($this->ERPfunction->retrive_accessrights($role,'approve1assetpoalert')==1)
								{
								?>
								<th>Approve</th>
								<?php
								}
								if($this->ERPfunction->retrive_accessrights($role,'approve2assetpoalert')==1)
								{
								?>
								<th>Final Approve</th>
								<?php
				...
				<tbody>
					...
					echo $this->ERPfunction->get_assetpo_alerts($selected_project);
					?>
