...
jQuery(document).ready(function() {
	...
	jQuery('.viewmodal').click(function(){
			...
			jQuery('#load_modal .modal-content').html('');
...
$purchase_date=isset($asset_data['purchase_date'])?date("d-m-Y",strtotime($asset_data['purchase_date'])):'';
...
?>               <div class="block block-fill-white">
                    ...
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4"><input <?php echo $asset_name_readonly; ?> type="text" name="asset_name" value="<?php echo $asset_name;?>" class="form-control validate[required]"/></div>
							<div class="col-md-2">Asset Capacity</div>
                            <div class="col-md-4"><input type="text" name="capacity" value="<?php echo $capacity;?>" class="form-control"/></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Make:</div>
                            <div class="col-md-6">	
								<select style="width: 100%;" class="select2" required="true"  name="asset_make" id="make_in">
							...
							<div class="col-md-4">
							<button type="button" id="asset_make_in" data-type="make_in" data-toggle="modal" 
						...
						<div class="form-row" style="display:none;">						
                            ...
                            <div class="col-md-4"><input type="text" name="purchase_quantity" id="purchase_quantity" value="1" class="form-control validate[required]"/></div>
							<div class="col-md-2">Unit *</div>
                            <div class="col-md-4"><input type="text" name="unit" value="<?php echo $unit;?>" class="form-control validate[required]" /></div>
							
                        </div>
						
						<div class="form-row">
                            <div class="col-md-2">Model No</div>
                            <div class="col-md-4"><input type="text" name="model_no" value="<?php echo $model_no;?>" class="form-control"/></div>
							<div class="col-md-2">Identity / Veh. No.</div>
                            <div class="col-md-4"><input type="text" name="vehicle_no" value="<?php echo $vehicle_no;?>" class="form-control"/></div>
                        </div>						
						
						<div class="form-row">
                            <div class="col-md-2">Date of Purchase *</div>
                            <div class="col-md-4"><input id="date_of_purchase" type="text" name="purchase_date" value="<?php echo $purchase_date;?>" onkeydown="return false" class="form-control validate[required]"/></div>
                        
                            <div class="col-md-2">Amount of Purchase *</div>
                            <div class="col-md-4">
								 <input type="text" name="purchase_amount" value="<?php echo $purchase_amount;?>" class="form-control validate[required]"/>
							</div>
						</div>
                        
						<div class="form-row">
                             <div class="col-md-2">P.O. No.</div>
                            <div class="col-md-4"><input type="text" name="po_no" value="<?php echo $po_no;?>" class="form-control"/></div>
                        
                            <div class="col-md-2">Warranty Period</div>
                            <div class="col-md-4">
							 <input type="text" name="warranty_period" value="<?php echo $warranty_period;?>" class="form-control"/> 
							</div>
						</div>
						<div class="form-row rto_fld" style="display:none;">
                             <div class="col-md-2">RTO Registration No.</div>
                            <div class="col-md-4"><input type="text" name="rto_reg_no" value="<?php echo $rto_reg_no;?>" class="form-control"/></div>
                        
                            <div class="col-md-2">Due Date of Registration</div>
                            <div class="col-md-4">
							 <input type="text" name="due_date_reg_old" onkeydown="return false" value="<?php echo $due_date_reg;?>" class="datepick form-control"/> 
							</div>
						</div>
						<div class="form-row">
							...
							<div class="col-md-2">
								<select name="road_tax_status" id="road_tax_status">
                            ...
                            <div class="col-md-2" id="due_date_road_tax_div" style="visibility:<?php echo ($road_tax_status)?"visible":"hidden";?>">
							 <input type="text" name="due_date_road_tax" onkeydown="return false" value="<?php echo $due_date_road_tax; ?>" class="datepick form-control due_date_road_tax"/> 
							</div>
							
                            <div class="col-md-2">Due Date of Passing / Registration</div>
                            <div class="col-md-2">
								<select name="passing_registration_status" id="passing_registration_status">
                            ...
                            <div class="col-md-2" id="passing_registration_div" style="visibility:<?php echo ($passing_registration_status)?"visible":"hidden";?>">
							 <input type="text" name="due_date_reg" onkeydown="return false" value="<?php echo $due_date_reg;?>" class="datepick form-control due_date_reg"/> 
							</div>
						</div>
						<div class="form-row">
                             <!--<div class="col-md-2">Insurance Company</div>
                            ...
                            <div class="col-md-2">
								<select name="fitness_status" id="fitness_status">
                            ...
                            <div class="col-md-2" id="due_date_fitness_div" style="visibility:<?php echo ($fitness_status)?"visible":"hidden";?>">
							 <input type="text" name="due_date_fitness" onkeydown="return false" value="<?php echo $due_date_fitness; ?>" class="datepick form-control due_date_fitness"/> 
							</div>
                            ...
                            <div class="col-md-2" id="due_date_insurance_div" style="visibility:<?php echo ($insurance_status)?"visible":"hidden";?>">
							 <input type="text" name="due_date_insurance" onkeydown="return false" value="<?php echo $due_date_insurance; ?>" class="datepick form-control due_date_insurance"/> 
							</div>
						</div>
						...
						<div class="form-row" style="display:none;">
                            ...
                            <div class="col-md-10">
								<select style="width: 100%;" class="select2" required="true"  name="deployed_to" id="deployed_to">
								...
								foreach($project_data as $key => $retrive_data)
								{
									if($asset_action == "edit")
									{
										$selected = $this->ERPfunction->selected($retrive_data['project_id'],$deployed_to);
									}else{
										$selected = $this->ERPfunction->selected($retrive_data['project_id'],2);
									}
									echo $retrive_data['project_id'];
									echo '<option value="'.$retrive_data['project_id'].'" '.$selected.'>'.$this->ERPfunction->get_projectname($retrive_data['project_id']).'</option>';
								}  
								?>
								</select>
							</div>
						...
						<div class="form-row" style="display:none;">						
                            ...
                            <div class="col-md-4"><input type="text" name="quantity" id="deployed_quantity" value="1" class="form-control validate[required]"/></div>
						</div>
						...
						<div class="form-row">
							...
							<div class="col-md-4">
								<input type="file" name="asset_picture" id="asset_picture" class="form-control imageUpload">
						...
						<div class="form-row">
							...
							<div class="col-md-2"></div>
                            <div class="col-md-4"><button type="submit" class="btn btn-primary"> Cancel </button></div>
                        </div>
						<?php
					if($asset_action == 'edit')
					{
					?>
						<div class="form-row">
							...
							<div class="col-md-4"><?php echo "Last Edited On :".$last_edit_on; ?></div>
                        </div>
					<?php
					}
					?>
