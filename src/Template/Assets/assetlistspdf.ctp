<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="assets_list.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>Assets List</b></td>");
		...
		unset($rows[0]);
		$header = array("Asset ID","Asset Name","Capacity","Make","Identity/Veh.No.","Date of purchase","Operational Status","Currently Deployed to","Total Maintenance Expence");
