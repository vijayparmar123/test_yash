<?php
	...
	$mpdf->WriteHTML("<tr>");
	$mpdf->WriteHTML("<td colspan='13'  style='border-right:0' align='center'><h2><strong><u>Asset Purchase Order</u> (<u>P.O.</u>)</strong></u></h3></td>");
	$mpdf->WriteHTML("</tr>");
	...
	/*$mpdf->WriteHTML("<tr>");
	$mpdf->WriteHTML("<td colspan='1' align='left'><b>P.O. Type : </b></td>");
	$mpdf->WriteHTML("<td colspan='11'>{$type_name}</td>");
	$mpdf->WriteHTML("</tr>");*/
	...
	$mpdf->WriteHTML("<tr>");
	$mpdf->WriteHTML("<td rowspan='16' valign='top' style='border-bottom:0;'><strong> Remarks/Note:</strong></td>");
