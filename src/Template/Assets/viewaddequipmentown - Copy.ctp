	...
	<?php echo $this->Form->Create('form1',['id'=>'eq_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
        ...
        <div class="content controls">
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="el_date" readonly="true" value="<?php echo date("d-m-Y",strtotime($record['date'])); ?>" class="datepick form-control validate[required]">
				</div>	
			</div>
			
			<div class="form-row" style="display:none;">
				<div class="col-md-offset-3 col-md-1">
					<input type="radio"  readonly="true" name="ownership" class="toggle_box" value="rent">On Rent
				</div>
				<div class="col-md-4">
					<input type="radio" readonly="true" name="ownership" class="toggle_box" value="owned" checked>Owned
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<select style="width: 100%;" disabled class="select2" required="true"  name="asset_name" id="asset_namelist">
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<select style="width: 100%;" disabled class="select2" required="true"  name="working_status" id="working_status">
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="duty_time" readonly="true" id="duty_time" class="form-control validate[required,custom[number]]" value="<?php echo $record['duty_time']; ?>">
				</div>
				<div class="col-md-2">Breakdown Time(hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="breakdown_time" readonly="true" id="breakdown_time" class="form-control validate[required,custom[number]]" value="<?php echo $record['breakdown_time']; ?>">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="start_km" readonly="true" id="start_km" class="form-control validate[required,custom[number]] asset_km" value="<?php echo $record['start_km']; ?>">
				</div>
				<div class="col-md-2">Start (hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="start_hr" readonly="true" id="start_hr" class="form-control validate[required,custom[number]] asset_hr" value="<?php echo $record['start_hr']; ?>">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="stop_km" readonly="true" id="stop_km" class="form-control validate[required,custom[number]] asset_km" value="<?php echo $record['stop_km']; ?>">
				</div>
				<div class="col-md-2">Stop (hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="stop_hr" readonly="true" id="stop_hr" class="form-control validate[required,custom[number]] asset_hr" value="<?php echo $record['stop_hr']; ?>">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="driver_name" readonly="true" class="form-control validate[required]" value="<?php echo $record['driver_name']; ?>">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<textarea name="usage_detail" readonly="true" class="form-control"><?php echo $record['usage_detail']; ?></textarea>
				</div>					
			</div>
