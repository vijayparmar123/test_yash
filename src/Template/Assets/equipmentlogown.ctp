	...
	<?php echo $this->Form->Create('form1',['id'=>'eq_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
        ...
        <div class="content controls">
			<div class="form-row">
				...
				<div class="col-md-4">
					<input type="text" name="project_code" id="project_code" class="form-control validate[required]" readonly="true"/>
				</div>
			...
			<div class="form-row">							
				...
				<div class="col-md-4">
					<input name="el_date" class="datepick form-control validate[required]">
				</div>	
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input class="form-control" type="hidden" name="asset_group" id="asset_group_id" value="" />
					<input class="form-control" readonly="true" id="asset_group_name" value="" />
				</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input type="text" name="model_no" readonly="true" id="model_no" value="" class="form-control validate[required]"/>
				</div>
				<div class="col-md-2">Identity / Veh. No.</div>
				<div class="col-md-4">
					<input type="text" name="vehicle_no" readonly="true" id="vehicle_no" value="" class="form-control"/>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="duty_time" id="duty_time" class="form-control validate[required,custom[number]]">
				</div>
				<div class="col-md-2">Breakdown Time(hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="breakdown_time" id="breakdown_time" class="form-control validate[required,custom[number]]">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="start_km" id="start_km" class="form-control validate[required,custom[number]] asset_km">
				</div>
				<div class="col-md-2">Start (hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="start_hr" id="start_hr" class="form-control validate[required,custom[number]] asset_hr">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="stop_km" id="stop_km" class="form-control validate[required,custom[number]] asset_km">
				</div>
				<div class="col-md-2">Stop (hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="stop_hr" id="stop_hr" class="form-control validate[required,custom[number]] asset_hr">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="usage_km" id="usage_km" readonly="true" class="form-control validate[required,custom[number]]">
				</div>
				<div class="col-md-2">Usage (hr.)<span class="require-field">*</span> :</div>
				<div class="col-md-4">
					<input name="usage_hr" id="usage_hr" readonly="true" class="form-control validate[required,custom[number]]">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input name="driver_name" class="form-control validate[required]">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<textarea name="usage_detail" class="form-control"></textarea>
				</div>					
			</div>
