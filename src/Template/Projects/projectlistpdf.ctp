<?php 
	...
	error_reporting(0);
		...
		$mpdf->WriteHTML("<td align=left><b>Project List</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Code","Project Name","Project Status","Clients Name","Contract Amount","Contract Start Date","Contract End Date","Revised Amount","Revised Completion Date","Total  of RA  Bill (Rs.)","Total Price Variation (Rs.)","Total Work Done (Rs.)","% Work Done");
