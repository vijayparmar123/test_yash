<?php 
	...
	error_reporting(0);
		...
		$mpdf->WriteHTML('</head>');
		$mpdf->WriteHTML('<body>');	
		$mpdf->SetTitle('Tender/Contract Notification List');	
		...
		$mpdf->WriteHTML("<td align=left><b>Tender/Contract Notification List</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Code","Project Name","Message","Event Date","Type Of Event");
