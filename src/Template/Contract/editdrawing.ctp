	...
	jQuery('body').on('click','.trash',function(){
		...
		if(detail_id)
		{
	 	 ...
	 	 jQuery.ajax({
                ...
                type:"POST",
                url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'deletedrawingdetail'));?>",
                data:curr_data,
                async:false,
                success: function(response){
					...
					<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<input type="text" name="drawing_no" value="<?php echo $data['drawing_no'] ?>" class="form-control validate[required]"/>
							</div>
                        </div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-10">
								<input type="text" name="drawing_title" value="<?php echo $data['drawing_title'] ?>" class="form-control validate[required]"/>
							</div>
						</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<input type="text" name="issued_by" value="<?php echo $data['issued_by'] ?>" class="form-control"/>
							</div>
						</div>
						<div class="form-row">
                            ...
                            <table class="table table-bordered">
								...
								?>
									<tr id="row_id_<?php echo $i; ?>">
										<td>
											<input type="text" value="<?php echo $retrive_data['revision_no']; ?>" name="drawing[revision_no][]" class="validate[required]" id="revision_no_<?php echo $i; ?>">
										...
										<td>
											<input type="text" value="<?php echo date('d-m-Y',strtotime($retrive_data['receipt_date'])); ?>" name="drawing[receipt_date][]" class="datepick" id="receipt_date_<?php echo $i; ?>">
										</td>
										<td>
											<input type="text" value="<?php echo $retrive_data['remarks']; ?>" name="drawing[remark][]" id="remark_<?php echo $i; ?>">
										</td>
										<td>
											<input type="text" value="<?php echo $retrive_data['attach_name']; ?>" name="drawing[attach_name][]" class="validate[required]" id="attach_name_<?php echo $i; ?>">
										</td>
										<td>
										...
										<td>
											<span class="trash btn btn-danger" detail-id="<?php echo $retrive_data['detail_id']; ?>"><i class="fa fa-trash"></i> Delete</span>
										</td>
									</tr>
								<?php $i++; } ?>
								</tbody>
