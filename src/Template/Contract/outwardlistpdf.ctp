<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="outward_list.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>Outward List</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Name","Our Outward No.","Our Outward Date","Their Ref. No.","Their Ref. Date","Agency Name","Subject");
