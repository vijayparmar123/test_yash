...
<div class="col-md-12" >		
					...
					<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<select class="select2" disabled="true"  required="true"   style="width: 100%;" name="project_id" id="project_id">
								...
								<input type="hidden" name = "project_id" id ="project_id" value="<?php echo $wo_data['project_id']; ?>">
							</div>
                        </div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								...
								<input type="text" name="wo_no" id="wo_no" value="<?php echo $wo_no; ?>" class="form-control" value="" readonly="true"/>
							</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								...
								?>
								<select class="select2"  required="true" disabled="true" style="width: 100%;" name="party_id" id="party_id">
									...
									?>
									<input type="hidden" name="party_id" id ="party_id" value="<?php echo $wo_data['party_userid']; ?>">
								</select>
							</div>
                        
                             <div class="col-md-2">party ID:</div>
                            <div class="col-md-4">
								<input type="text" name="party_identy" id="party_identy" value="<?php echo $wo_data['party_id']; ?>" class="form-control" readonly="true" value=""/>
							</div>
                        </div>
						<div class="form-row">
		...
		<tr id="row_id_<?php echo $i; ?>">
			...
			<td>
				...
				<?php 
					if($data['detail_description'] != NULL) {
						echo '<input type="text" value="'.$data["detail_description"].'" placeholder="Description Here" class="desc_textfield" name="material[detail_description][]" value=""  id="detail_description'.$i.'" >';
					}else {
						echo '<input type="text" value="'.$data["detail_description"].'" placeholder="Description Here" class="desc_textfield" name="material[detail_description][]" value="" id="detail_description'.$i.'" style="display:none;">';
					}
				?>
			</td>
			
			<!-- <td> 
				<input type="text" name="material[detail_description][]" style="width:200px;" value="<?php //echo $data['detail_description']; ?>" class="detail_description" data-id="0" id="detail_description_0"/>
			</td> -->

			<td> 
				<input type="text" name="material[quantity_this_wo][]" value="<?php echo ($can_update)?$data['quentity']:0; ?>" class="quantity_this_wo" data-id="<?php echo $i; ?>" id="quantity_this_wo_<?php echo $i; ?>"/>
			</td>

			<td> 
				<input type="text" name="material[quantity_previous_wo][]" style="width:80px;" value="<?php echo ($can_update)?$data['quantity_upto_previous']:htmlspecialchars($data['till_date_quantity']); ?>" readonly="true" class="quantity_previous_wo" data-id="0" id="quantity_previous_wo_<?php echo $i; ?>"/>
			</td>
			<td> 
				<input type="text" name="material[quantity_till_date][]" style="width:80px;" value="0" readonly="true" class="quantity_till_date" data-id="0" id="quantity_till_date_<?php echo $i; ?>"/>
			</td>
			...
			<td>
				<input type="text" name="material[unit_rate][]" value="<?php echo ($can_update)?$data['unit_rate']:$data['unit_rate']; ?>" class="unit_rate" data-id="<?php echo $i; ?>" id="unit_rate_<?php echo $i; ?>" style="width:80px" />
			</td>
			...
			<td>
				<input type="text" name="material[amount][]" value="0" class="amount" id="amount_<?php echo $i; ?>" style="width:90px" />
			</td>

			<td>
				<input type="text" name="material[amount_till_date][]" readonly="true" value="0" class="amount_till_date" id="amount_till_date_<?php echo $i; ?>" style="width:90px" />
			</td>
	...
	<tfoot>
		...
		<tr id="cgst_row">
			...
			<td colspan="1" style="padding-left:24px;">
				...
				<input type="hidden" name="cgst" id="cgst_0" value="0" class="cgst validate[custom[number]]" data-id="0" style="width:80px;">
			</td>
			<td colspan="1" style="padding-left:24px;">
		...
		<tr id="sgst_row">
			...
			<td colspan="1" style="padding-left:24px;">
				<span class="sgst">0</span>
				<input type="hidden" name="sgst" id="sgst_0" value="0" class="sgst" data-id="0" style="width:80px;">
			</td>
			<td colspan="1" style="padding-left:24px;">
		...
		<tr id="igst_row">
			...
			<td colspan="1" style="padding-left:24px;">
				<span class="igst">0</span>
				<input type="hidden" name="igst" id="igst_0" value="0" class="igst" data-id="0" style="width:80px;">
			</td>
			<td colspan="1" style="padding-left:24px;">
		...
		<tr>
			...
			<input type="hidden" name="net_amount" value="0" class="net_amount">
			</td>
