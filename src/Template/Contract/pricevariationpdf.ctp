<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="price_variation.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>Price Variation</b></td>");
		...
		unset($rows[0]);
		$header =  array("Project Name","Price Variation No.","As On Date","Net Amount.","Date Of Payment");
