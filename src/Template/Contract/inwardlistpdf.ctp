<?php 
	...
	error_reporting(0);
		...
		$mpdf->WriteHTML("<td align=left><b>Inward List</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Name","Our Inward No.","Our Inward Date","Their Ref. No.","Their Ref. Date","Agency Name","Subject");
