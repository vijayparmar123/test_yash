<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="drawingrecords.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>Drawing Records</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Name","Drawing Type","Building/Other Reference","Drawing NO","Drawing Title","Last Revision No","Last Date Of Receipt","Last Attachment");
