		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td colspan="11" > <?php echo $wo_data['wo_no']; ?></td>					
				</tr>				
				<tr>
...
<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-7 pull-right">
								<br><br><br>
								<div class="col-md-2">						 
								  <a href="../printworecord/<?php echo $wo_data["wo_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
