		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo $this->ERPfunction->get_category_title($retrive_material['material_name']);?> <br> 
						(<?php echo $retrive_material['detail_description']; ?>)
					</td>
...
<!-- remarks 1 start -->
		<tbody id="remark_1" style="<?php echo ($wo_data['contract_type'] == 1 || $wo_data['contract_type'] == 3 || $wo_data['contract_type'] == 4)?'':'display:none' ?>">
				...
				<tr>
					<td colspan="12" > 
						2) You are also binded to our Contract Conditions & Specifications with Client; which are provided to you.
					</td>
				</tr>
				
			
				<tr>
					<td colspan="12" >3) If work will found unsatisfactory afterwards; agency/party has to correct it free of cost. </td>
				</tr>
				<tr>
					<td colspan="12" > 4) Always get your work checked and verified by our Engineer In-charge, PMC/TPI, Client and other consultants also take their prior approval before starting work. </td>
				</tr>
				<tr>
					<td colspan="12" > 5) Quantity may vary up to any extend afterwards; payment will be done on actual supply & its acceptance. </td>
				</tr>
				<tr>
					<td colspan="12" > 6) If you will not revert back within 48 hrs, this WO will be considered as accepted by you. </td>
				</tr>
				
				<tr>
					<td colspan="12" > 7) In case of ambiguity; our Engineer In-charge’s decision will be final and party has to obey it. </td>
				</tr>
				
				<tr>
					<td colspan="12" > 8) All disputes subject to Ahmedabad Jurisdiction only. </td>
				</tr>
				
				<tr>
					<td colspan="12" > 9) All Tools, Tackles & Equipment for completing the work need to be procured by you at your cost. </td>
				</tr>
				
				<tr>
					<td colspan="12" > 10) Agency/party needs to maintain and obey all safety rules & standards. </td>
				</tr>
				
				<tr>
					<td colspan="12" >11) For payment party will have to submit <strong> Invoice along with Work Order (WO), Measurement Sheet along with Abstract duly signed by Construction Manager, Billing Engineer & Site Accountant.</strong> </td>
				</tr>
				...
				<tr>
					<td colspan="13" >12) Your Invoice will be paid after deduction of advances, any type of debit notes, credit notes, retention money / security deposit, taxes etc.</td>
				</tr>
				<tr>
					<td colspan="13" >13) Retention Money / Security Deposit will be deducted from every bills and will be released after satisfactory work completion.</td>
				</tr>
				<tr>
					<td colspan="13" >14) <?php echo $this->ERPfunction->getconditionofpowo($wo_data["wo_date"],$wo_data["bill_mode"]); ?></td>
				</tr>
				<tr>
					<td colspan="13" > 15) Payment will be done <strong><?php echo $wo_data["payment_days"];?></strong> days after date of delivery on site or bill submission which ever is later.</td>
				</tr>
				<tr>
					<td colspan="13" >
...
<!-- remarks 2 start -->
			<tbody id="remark_2" style="<?php echo ($wo_data['contract_type'] == 5 || $wo_data['contract_type'] == 6 || $wo_data['contract_type'] == 7 || $wo_data['contract_type'] == 2)?'':'display:none' ?>">
				...
				<!--<tr>
					...
					<td colspan="12" > <strong>Billing Address:</strong>214/5, Khyati Complex, Near Mithakhali Underbridge, Ellisbridge, Ahmedabad - 380006,Gujarat</td>
					<?php  }else{ ?>
					<td colspan="12" > <strong>Billing Address:</strong>A-312, The Bellaire Campus, Abbas Nagar Road, Near Asharam Square, Gandhinagar, Bhopal,M.P. - 462036.</td>
					<?php }  ?>
				</tr>-->
				<tr>
					<?php if($wo_data["bill_mode"] == "gujarat") {?>
			...
			<tbody>
				...
				<tr>
					<td valign="bottom"  align="center"  height="120" colspan="12"> 					
					...
					<td valign="bottom" align="center" height="120"><font size="4"><strong><?php echo $this->ERPfunction->getletterheadsign($wo_data["wo_date"],$wo_data['bill_mode']); ?></strong><br><br>(<?php echo $this->ERPfunction->get_user_name($first_approved_by);?>)<br><strong>Authorized Signatory</strong></font></td>
					<!--<td valign="bottom" align="center" height="120" colspan="4"><font size="4"><strong>For YashNand Engineers & Contractors</strong><br><br><br><strong>Authorized Signature-2</strong></font></td>-->
				</tr>
...
<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-7 pull-right">
								<br><br><br>
								<div class="col-md-2">						 
								  <a href="../printplanningworecord/<?php echo $wo_data["wo_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
						...
						<!--<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-7 pull-right">
								<br><br><br>
								<div class="col-md-2">						 
								  <a href="../printwo/<?php //echo $wo_data["wo_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>-->
	</div>
