<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="worecords.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>W.O. Records</b></td>");
		...
		unset($rows[0]);
		$header = array("Date","W.O. No","Project Name","Party Name","Type of Contract","Amount");
