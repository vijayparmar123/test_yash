	...
	<div class="row">
				...
				jQuery(document).ready(function() {
					...
					var table = jQuery('#wo_list').DataTable({
						...
						"ajax": {
							...
							url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'planningammendedworecords'));?>",
							"data": function ( d ) {
								d.myKey = "myValue";
		...
		<div class="content list custom-btn-clean">
			...
			<div class="content">
				...
				<div class="col-md-2">
				<?php echo $this->Form->Create('join_form',['url'=>['controller'=>'contract', 'action'=>''],'class'=>'form_horizontal formsize','method'=>'post','id'=>'join_form','enctype'=>'multipart/form-data']);?>
