...
var csrfToken = <?= json_encode($this->request->getParam('_csrfToken')) ?>;
	...
	jQuery(document).ready(function() {
		...
		// Open modal for adding new work head form
		...
		getEnableProject = () => {
			...
			var woId = "<?php echo $woId ?>";
			// alert(woId);return false;
			var curr_data = {
				project_id : project_id,
			...
			headers: {
				...
				success : function(data) {
					...
					jQuery("select.material_name").append(desc);
					jQuery(".select .material_name").val(data);
					jQuery("#load_modal_enable_description").modal("hide");
				},
				error : function(e) {
					console.log(e);
		...
		// Add More Type Of Work 
		jQuery("body").on("click", "#save", function(event){	 
			var type_of_contract  = jQuery("#contract_workhead").val();
			...
			if(type_of_contract == '' || work_head_code == '' || work_head_title == '' || projectId == '')
			{
			...
			var curr_data = {
				type_of_contract : type_of_contract, work_head_code : work_head_code , work_head_title :work_head_title, project_id : projectId				
			};	 				
			jQuery.ajax({
				headers: {
				'X-CSRF-Token': csrfToken
		...
		// onclick of enable button modal
		...
		// On Select of material name in dropdown 
		// jQuery("body").on("change",".material_name",function() {
		// 	var dataId = $(this).attr("data-id");
		// 	var projectId = $("#project_id").val();
		// 	var selectedVal = $("#material_name_"+dataId).val();
		// 	var woId = "<?php echo $woId; ?>";
		// 	var data = {
		// 		dataId : dataId,
		...
		// 	jQuery.ajax({
		// 		type : "POST",
		// 		url : "<?php echo Router::url(array("controller" => 'Ajaxfunction',"action" => 'enableselecteddescriptionvalue')) ?>",
		// 		data : data,
		// 		asyc : true,
		// 		success : function(response) {
		// 			if(response == "selected") {
		// 				$("select.material_name").attr("selected","selected");
		// 			}
		// 		},
		// 		error : function(e) {
		// 			console.log(e);
...
<div class="modal fade " id="load_modal_enable_description" role="dialog" style="z-index:9999;">
	<div class="modal-dialog modal-md">
		<div class="modal-content"></div>
	</div>
</div>
	...
	<div class="block block-fill-white">
		<div class="head bg-default bg-light-rtl">
			...
			<div class="pull-right">
				<a href="<?php echo $this->ERPfunction->action_link('Contract','planningapprovewo');?>" class="btn btn-success"><span class="icon-arrow-left"></span> Back</a>
			</div>
		</div>
		...
		<div class="content controls">						
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<input type="text" name="project_code" id="project_code" value="<?php echo $this->ERPfunction->get_projectcode($wo_data['project_id']);?>"
					class="form-control validate[required]" value="" readonly="true"/>
				</div>
				<div class="col-md-2">Project Name:</div>
				<div class="col-md-4">
					<select class="select2" disabled  required="true"   style="width: 100%;" name="project_id" id="project_id">
					...
					<input type="hidden" value = "<?php echo $wo_data['project_id']; ?>" name = "project_id">
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-4">
					<select class="select2" disabled required="true"   style="width: 100%;" name="party_id" id="party_id">
						...
						<option value="<?php echo $vendor_row['user_id']; ?>" dataid="vendor"
							...
							?>
						>
						<?php echo $vendor_row['vendor_name'];?>
						</option>
						<?php
							}
						}
					...
					<input type="hidden" value = "<?php echo $wo_data['party_userid'] ?>" name = "party_id">
				</div>
				<div class="col-md-2">party ID:</div>
				<div class="col-md-4">
					<input type="text" readonly name="party_identy" id="party_identy" value="<?php echo $wo_data['party_id']; ?>" class="form-control" value=""/>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<input type="text" readonly name="party_address"  id="party_address" class="form-control" value="<?php echo $wo_data['party_address']; ?>"/>
				</div>
			</div>	
			...
			<div class="form-row">						
				...
				<div class="col-md-4">
					<input type="text" readonly name="party_no1" id="party_no1" class="form-control" value="<?php echo $wo_data['party_no1']; ?>"/>
				</div>
				<div class="col-md-2">Contact No: (2)</div>
				<div class="col-md-4">
					<input type="text" readonly name="party_no2" id="party_no2" value="<?php echo $wo_data['party_no2']; ?>" class="form-control"/>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="col-md-10">
					<input type="text" readonly name="party_email"  id="party_email" class="form-control" value="<?php echo $wo_data['party_email']; ?>"/>
				</div>
			</div>
			...
			<div class="form-row">						
				...
				<div class="col-md-4">
					<input type="text" readonly name="party_pan_no" id="party_pan_no" value="<?php echo $wo_data['party_pan_no']; ?>" class="form-control"/>
				</div>
				<div class="col-md-2">GST No:</div>
				<div class="col-md-4">
					<input type="text" readonly name="party_gst_no" id="party_gst_no" value="<?php echo $wo_data['party_gst_no']; ?>" class="form-control"/>
				</div>
			</div>
				...
				<table class="table table-bordered">
						...
						<tr id="row_id_<?php echo $i; ?>">
							...
							<td>
								<select class="select2 material_name" required="true" style="width: 100%;" name="material[material_name][]" data-id="<?php echo $i; ?>" id="material_name_<?php echo $i; ?>">
									...
									<?php
										foreach($descriptionOptions as $key => $retrive_data) { 
								...
								<?php 
									if($data['detail_description'] != NULL) {
										echo '<input type="text" value="'.$data["detail_description"].'" placeholder="Description Here" class="desc_textfield" name="material[detail_description][]" value=""  id="detail_description_'.$i.'" >';
									}else {
										echo '<input type="text" value="'.$data["detail_description"].'" placeholder="Description Here" class="desc_textfield" name="material[detail_description][]" value="" id="detail_description_'.$i.'" style="display:none;">';
									}
								?>
							</td>

							<td> 
								<input type="text" name="material[quantity_this_wo][]" value="<?php echo htmlspecialchars($data['quentity']); ?>" class="quantity_this_wo" data-id="<?php echo $i; ?>" id="quantity_this_wo_<?php echo $i; ?>"/>
							</td>
							...
							<td>
								<input type="text" name="material[amount_till_date][]" value="<?php echo $data['amount_till_date']; ?>" class="amount_till_date" id="amount_till_date_<?php echo $i; ?>" style="width:90px" />
							</td>
			
							<td>
								<a href="javascript:void(0)" class="btn btn-primary add_textfield" onClick="insertRow(<?php echo $i; ?>)" id="textfield_<?php echo $i; ?>" data-id="<?php echo $data['wo_detail_id']; ?>" value="textfield">Textfield</a>
					...
					<tfoot>
						<tr>
							...
							<td id="total_wo_amount" style="padding-left:24px;">
								<?php echo $wo_data['sub_total']; ?>
							</td>
							<td id="sub_total_till_date" style="padding-left:24px;">
								<?php echo $wo_data['till_date_sub_total']; ?>
							<td>
			...
			<div class="form-row" id="remark_1" style="display:<?php echo ($remark_1)?'block':'none'; ?>">
                ...
                <div class="col-md-8">
					...
					<p>
						...
						<span class="pan_no"><?php echo $this->ERPfunction->getstatepanno($bill_mode,$wo_data["wo_date"]); ?></span>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<p>14) <?php echo $this->ERPfunction->getconditionofpowo($wo_data["wo_date"],$bill_mode); ?> </p>		
