...
{ ?>				
                <div class="block block-fill-white">					
					<div class="head bg-default bg-light-rtl">
						...
						<a href="<?php //echo $this->ERPfunction->action_link('Contract','viewpricevariation');?>" onclick = "javascript:window.close();" class="btn btn-success"><span class="icon-arrow-left"></span> Back</a>
						</div>
					</div>
...
<option value="<?php echo $retrive_data['project_id'];?>" <?php 
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4"><input type="text" name="bill_no" value="<?php echo $bill_no; ?>" id="reference_no" class="form-control validate[required]"  placeholder="0"  disabled /></div>
                        
                            <div class="col-md-2">Upto Date</div>
                            <div class="col-md-4"><input type="text" name="upto_date" value="<?php echo $upto_date; ?>" id="date_of_birth" class="form-control" placeholder="0"  disabled /></div>
                        </div>						
						
						<!-- <div class="form-row">						
								<div class="col-md-2">Amount of this Bill :</div>
								<div class="col-md-4"><input type="text" name="bill_amt" value="<?php // echo $bill_amt;?>" id = "" class="form-control"  placeholder="0"  disabled /></div>
								 <input type="hidden" value="<?php // echo $attachment_excel; ?>" name="old_ex">
								<div class="col-md-2">Attach Bill(Excel File):</div>
								<div class="col-md-4">
									<input type="file" name="attachment_excel" value="" class="form-control" placeholder="0"  disabled />
								</div>							
							</div>
						 <div class="form-row">
							
                            <div class="col-md-2">Total Deductions Amount:</div>
                            <div class="col-md-4"><input type="text" name="total_deduction_amt" value="<?php echo $total_deduction_amt; ?>" class="form-control" placeholder="0"  disabled /></div>
						...
						<div class="form-row">
							...
							value="<?php echo $paid_amt; ?>" class="form-control" placeholder="0"  disabled /></div>                        
                       
                            <div class="col-md-2">Date of Payment</div>
                            <div class="col-md-4"><input type="text" name="payment_date" value="<?php echo $payment_date; ?>" id="as_on_date" class="form-control" placeholder="0"  disabled /></div>
				...
				<div class="row" style="font-style:italic;color:gray;">							
					<div class="col-md-8 pull-right">
						...
						<div class="col-md-3">						 
						  <a href="../printpricevariation/<?php echo $update_variation['price_variation_id'];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
						</div>
					</div>
				</div>
			  </div>
