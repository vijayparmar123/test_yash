...
{ ?>				
                <div class="block block-fill-white">
					...
					<input type="hidden" name="user_action" class="form-control" value="" placeholder="0" />	
					
                    <div class="content controls">
						<!--<div class="form-row">                       
                            <div class="col-md-2">Agency ID</div>
                            <div class="col-md-4"><input type="text" id="vendor_id" name="agency_id" readonly value="<?php //echo $agency_id;?>" class="form-control" placeholder="0" /></div>
                        </div>-->
                        <div class="form-row">
                            <div class="col-md-2">Agency Name<span class="require-field">*</span></div>
                            <div class="col-md-4"><input type="text" name="agency_name" value="<?php echo $agency_name;?>" class="form-control validate[required]" placeholder="0" /></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Agency's Billing Address *</div>
                            <div class="col-md-4">							
                                <textarea name="agency_billing_address" placeholder="0" class="validate[required]"><?php echo $agency_billing_address;?></textarea>                                                         
                            </div>
						<!--	
							<div class="col-md-2">
					...
					<?php } ?>
						...
						<div class="form-row">						
                            ...
                            <div class="col-md-4"><input type="text" name="contact_no" value="<?php echo $contact_no;?>" class="form-control validate[required]" placeholder="0" /></div>
						</div>						
						<div class="form-row">
                            <div class="col-md-2">E-mail ID<span class="require-field">*</span> </div>
                            <!--<div class="col-md-4"><input type="text" name="email_id" value="<?php //echo $email_id;?>" class="form-control validate[required,custom[email]]" placeholder="0" /></div>-->
							<div class="col-md-4"><input type="text" name="email_id" value="<?php echo $email_id;?>" class="form-control validate[required]" placeholder="0" /></div>
                         </div>						
						
						<div class="form-row">
                             <div class="col-md-2">PAN Card No *</div>
                            <div class="col-md-4"><input type="text" name="pancard_no" value="<?php echo $pancard_no;?>" class="form-control validate[required]" placeholder="0" /></div>
                        
                            <!--<div class="col-md-2">VAT/TIN No</div>
                            <div class="col-md-4">
								 <input type="text" name="vat_tin_no" value="<?php //echo $vat_tin_no;?>" class="form-control" placeholder="0" />
							</div>-->
                         </div>
						 <!--<div class="form-row">
                             <div class="col-md-2">Service Tax No</div>
                            <div class="col-md-4"><input type="text" name="service_tax_no" value="<?php //echo $service_tax_no;?>" class="form-control" placeholder="0" /></div>
                        
                            <div class="col-md-2">CST No</div>
                            <div class="col-md-4">
								 <input type="text" name="cst_no" value="<?php //echo $cst_no;?>" class="form-control" placeholder="0" />
							</div>
                         </div>-->
						 <div class="form-row">
                             <div class="col-md-2">GST No</div>
                            <div class="col-md-4"><input type="text" name="gst_no" value="<?php echo $gst_no;?>" class="form-control" placeholder="0" /></div>
                        
                            <div class="col-md-2">A/C No</div>
                            <div class="col-md-4">
								<input type="text" name="ac_no" value="<?php echo $ac_no;?>" class="form-control" placeholder="0" />
							</div>
                         </div>
						 <div class="form-row">
                             <div class="col-md-2">Bank</div>
                            <div class="col-md-4"><input type="text" name="bank_name" value="<?php echo $bank_name;?>" class="form-control" placeholder="0" /></div>
                        
                            <div class="col-md-2">IFSC Code</div>
                            <div class="col-md-4">
								<input type="text" name="ifsc_code" value="<?php echo $ifsc_code;?>" class="form-control" placeholder="0" />
							</div>
                         </div>
						 <div class="form-row">
							...
							<div class="col-md-4">
                            <select class="select2" style="width: 100%;" name="transfer_type">
						...
						<div class="form-row">
							...
							<div class="col-md-4"><a type="submit" href="<?php echo $this->ERPfunction->action_link('Contract','agencylist');?>"class="btn btn-primary"><?php echo $button_text2;?></a></div>
                        </div>						
