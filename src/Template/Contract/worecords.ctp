...
<div class="row">
		...
		<div class="block">
			<div class="head bg-default bg-light-rtl">
				...
				<div class="pull-right">
					<a href="<?php echo $this->request->base;?>/Contract/preparewo" class="btn btn-success">Prepare W.O.</a> 
	...
	var table = jQuery('#wo_list').DataTable({
		...
		"ajax": {
				...
				url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'worecords'));?>",
				"data": function ( d ) {
											d.myKey = "myValue";
			...
			?>
				<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					...
					<div class="col-md-2">Party Name</div>
                        <div class="col-md-4">
							<select class="select2"  style="width: 100%;" name="party_userid[]" id="party_userid" multiple="multiple">
