<?php
	...
	$mpdf->WriteHTML("<td rowspan='2' width=100px align='center'><strong>Work Description</strong></td>");
	$mpdf->WriteHTML("<td rowspan='2' width=300px align='center'><strong>Detail Description</strong></td>");
