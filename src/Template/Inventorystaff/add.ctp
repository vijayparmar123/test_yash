...
$role=isset($user_data['role'])?$user_data['role']:'inventorystaff';
?>
...
<div class="col-md-10" >
                ...
                <div class="block block-fill-white">
					<div class="header">
						...
						<a href="<?php echo $this->ERPfunction->action_link('Inventorystaff','index');?>" class="btn btn-default">Back</a></h1>
