...
<div class="block">
		...
		<div class="content">
			<div class="col-md-12 filter-form">
				...
				<div class="form-row">
					...
					<div class="col-md-3">
						<input name="mobile_no" id="contact_no" type="text" disabled>
					</div>
				...
				<div class="form-row">
					...
					<div class="col-md-3">
						<input name="clam_period" required="true" id="date" class="form-control  date validate[required] datep" value="">
					</div>
		...
		<div class="col-md-6" >
			  <div class="block block-drop-shadow">
					...
					<input type="text" id="travel_charge" name="travel_charge" value="0"  class="inputs">
					</div> 
					<div class="content" style="background:#FBD4B4">
					<p class="filter-title"><b>B) House Rent/Hotel</b></p>
					<input type="text" id="house_charge" name="house_charge" value="0" class="inputs" >
					</div> 
					<div class="content" style="background:#FBD4B4">
					<p class="filter-title"><b>C) Mobile Bill</b></p>
					<input type="text" id="mobile_charge" name="mobile_charge" value="0" class="inputs"  >
					</div> 
					<div class="content" style="background:#FBD4B4">
					<p class="filter-title"><b>D) Food</b></p>
					<input type="text" id="food_charge" name="food_charge" value="0" class="inputs"  >
					</div> 
					<div class="content" style="background:#FBD4B4">
					<p class="filter-title"><b>E) Other Expense</b></p>
					<input type="text" id="other_charge" name="other_charge" value="0" class="inputs"  >
					</div> 
					<div class="footer" style="background: #FABF8F;">
						<p class="filter-title"><b>Total Amount</b></p>
						<input type="hidden" id="total_amount" name="total_amount">
						 <p class="heads"><b><span  id="total_amount1" name="total_bonus"></span></b></p>
					</div>
                </div><?php 
               ...
               if($this->ERPfunction->retrive_accessrights($role,'historyexpenditure')==1)
                ...
                <div class="remark">
                	...
                	<textarea class="form-control" style="color: black" name="remark"></textarea>
                </div>    
			</div>
		</div>
			<div class="row submit">
					<input type="submit"  id="submit"   class="btn btn-success" style='width:20%;'>
			</div>
	   </div>
		<?php } ?>
	   </div>
