<?php
	...
	header('Content-Disposition: inline; filename="designationhistory.pdf"');
	...
	$mpdf->WriteHTML("<tr>");
	$mpdf->WriteHTML("<td colspan='13' align='center'><h2><strong><u>Designation History</u></strong></u></h3></td>");
	$mpdf->WriteHTML("</tr>");
	...
	{
		$mpdf->WriteHTML("<td align='center'>{$user_data['designation_change_date']->format('d-m-Y')}</td>");
	}
	else
	{
