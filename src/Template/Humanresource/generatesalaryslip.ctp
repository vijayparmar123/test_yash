...
$(document).ready(function(){
	...
	{			
		change_affected_date = new Date(<?php echo $year; ?>, <?php echo ($month==1)?$month:$month-1; ?>);
		var apply_date = new Date('2019', '6');
		var esi_percentage=0.75;
		...
		var count_esi = parseFloat(total_earning - incentive_val)*esi_percentage/100;
		$("#show_esi").html(Math.ceil(count_esi));
		$(".unhide_esi").val(Math.ceil(count_esi));
