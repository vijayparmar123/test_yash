			...
			<div class="form-row">						
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="text-right"> 
							<span><?php echo $data['others']?></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="text-right">
							<span><?php echo $data["loan_payment"]; ?></span>
						</td>
					</tr>
					<tr>
			...
			<div class="form-row">
				<div class="col-md-6 pull-right">
						...
						<div class="col-md-2 pull-right">						 
							<a href="../printsalarybill/<?php echo $data["slip_id"]; ?>" class="btn btn-info	" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
						</div> 
					</div>
			</div>
		</div>
