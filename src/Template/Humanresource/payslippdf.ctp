<?php 
	...
	error_reporting(0);
		...
		unset($rows[0]);
		$header = array("Employee at","Employee No","Name of Employee","Designation","Present","Holidays","Used PL","Payable days","Working days","Paid days","CTC (Month)");
