<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="view_records.pdf"');
		...
		$mpdf->SetTitle('View Salary Records List');	
		...
		unset($rows[0]);
		$header = array("Status","Employee No","First Name","Middle Name","Last Name","Mobile No","Education","Designation","Employee At","Pay Type","CTC(Month)(Rs.)"
						,"CTC(Year)(Rs.)");
