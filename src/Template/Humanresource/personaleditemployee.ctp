...
?>	
                <div class="block block-fill-white">
					...
					<?php } }	?>
						...
						<?php if($user_action == 'insert') { ?>
						<div class="candidate_check">

						 <div class="col-md-2">Candidate Id<span class="require-field">*</span> </div>
                           	 <div class="col-md-2">
								<select class="select2" id="candidate" style="width: 100%;" class="form-control validate[required]" name="candidate_id"  required="true"  >
				 ...
				 array('class'=>'userimage','height'=>'50px','width'=>'50px')); ?>
                                <div class="input-group">                                    
                                    ...
                                    <input type="file" name="user_image_url">
					 ...
					 <div class="form-row" style="display:none;">
					   ...
					   <div class="form-row" style="display:none;">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<input type="file"  name="aadhar_card_att" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="pan_card_att" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="driving_licence_att" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="cancel_cheque_att" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="resume_att" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="qualification_doc" class="input-file">
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="other_doc" class="input-file">
