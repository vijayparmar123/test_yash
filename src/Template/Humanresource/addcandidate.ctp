                ...
                <div class="block block-fill-white">
					...
					<div class="content controls">						
						...
						<div class="form-row">
                            ...
                            <div class="col-md-2"><input type="text" name="middle_name" value="<?php echo $middle_name;?>" class="form-control" /></div>
							
							<div class="col-md-2">Last Name<span class="require-field">*</span> </div>
                            <div class="col-md-2"><input type="text" name="last_name" value="<?php echo $last_name;?>" class="form-control validate[required]" /></div>
					   ...
					   <div class="form-row">
                            ...
                            <div class="col-md-2"><input type="text" name="education" value="<?php echo $education;?>" class="form-control" /></div>
							
							<div class="col-md-2">Year of Passing</div>
                            <div class="col-md-2"><input type="text" name="year_of_passing" value="<?php echo $year_of_passing;?>" class="form-control" /></div>
					   ...
					   <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <div class="radiobox-inline">
                                    <label><input type="radio" name="marital_status" value="Married" <?php echo $this->ERPfunction->checked($marital_status,'Married');?>/>Married</label>
                                </div>
                                <div class="radiobox-inline">
                                    <label><input type="radio" name="marital_status" value="Single" <?php echo $this->ERPfunction->checked($marital_status,'Single');?>/>Single</label>
                                </div>         
                            </div>
                            ...
                            <div class="col-md-2">Passport No.</div>
                            	<div class="col-md-2">
                                    	...
                                    	<input type="text" name="passport_no" value="<?php echo $passport_no;?>" class="form-control" />
					   ...
					   <div class="form-row">
                            ...
                            <div class="col-md-2"> 
								<input type="text" name="pan_card_no" value="<?php echo $pan_card_no;?>" class="form-control" />
                            </div>
							<div class="col-md-2">Driving Licence No</div>
                            <div class="col-md-2"><input type="text" name="driving_licence_no" value="<?php echo $driving_licence_no;?>" class="form-control" /></div>
											
					   
					   
                          	<div class="col-md-2">Adhaar Card No</div>
                            <div class="col-md-2"> 
								<input type="text" name="adhaar_card_no" value="<?php echo $adhaar_card_no;?>" class="form-control" />
                            </div>						
                      	</div>				
						 <div class="form-row">
				 ...
				 array('class'=>'userimage','height'=>'50px','width'=>'50px')); ?>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-2"><input type="text" name="mobile_no" value="<?php echo $mobile_no;?>" class="form-control validate[required]" /></div>
                        
                            <div class="col-md-2">E-mail ID</div>
                            <div class="col-md-4"><input type="text" name="email_id" value="<?php echo $email_id;?>" class="form-control" /></div>
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Address</div>
                            <div class="col-md-10">
								<textarea name="employee_address" class="form-control"><?php echo $employee_address; ?></textarea>
							</div>
                        </div>
					<!--	<div class="form-row"><hr/>					
						...
						<div class="form-row">
                            ...
                            <div class="col-md-2"><input type="text" name="interview" id="interview" onkeydown="return false" value="<?php echo $interview;?>"
							class="form-control validate[required]" /></div>
                            ...
                            <div class="col-md-2"><input type="text" name="interview_by" 
							value="<?php echo $interview_by;?>" class="form-control" /></div>
							
							<div class="col-md-2">Interview Grade</div>
                            <div class="col-md-2"><input type="text" name="inerview_grade" value="<?php echo $inerview_grade;?>" class="form-control" /></div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">Interview Comment</div>
                            <div class="col-md-10">
								<textarea name="interview_comment" class="form-control"><?php echo $interview_comment; ?></textarea>
							</div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">CTC Year. <span class="require-field">*</span> </div>
                            <div class="col-md-2"><input type="text" name="ctc_year" value="<?php echo $ctc_year;?>" class="form-control validate[required]" /></div>
                        </div>
                         <div class="form-row">
					   ...
					   <div class="form-row" style="display:none;">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_aadhar_card_att" value="<?php echo $old_aadhar_card_att ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_pan_card_att" value="<?php echo $old_pan_card_att ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_driving_licence_att" value="<?php echo $old_driving_licence_att ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_cancel_cheque_att" value="<?php echo $old_cancel_cheque_att ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_resume_att" value="<?php echo $old_resume_att ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								<input type="file" name="qualification_doc" class="input-fileimageUpload">
								<span class='required red notice'></span>
								<input type="hidden" name="old_qualification_doc" value="<?php echo $old_qualification_doc ?>">
							</div>
						...
						<div class="form-row">							
                            ...
                            <div class="col-md-4">
								...
								<span class='required red notice'></span>
								<input type="hidden" name="old_other_doc" value="<?php echo $old_other_doc ?>">
							</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><button type="submit" onclick="return ValidateExtension()" class="btn btn-primary"><?php echo $button_text;?></button></div>
                        </div>
				</div>
				<?php $this->Form->end(); ?>
			</div>
