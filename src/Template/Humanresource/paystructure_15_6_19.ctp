					...
					<div class="content controls">
					   ...
					   <div class="form-row">
						...
						<div class="col-md-3 text-right">H.R.A.(Rs.)<span class="require-field">*</span> </div>
                            <div class="col-md-3">								
								<input type="radio" name="acco_allowance" class="acc_rad" value="company_provided" <?php echo $this->ERPfunction->checked($acco_allowance,'company_provided');?>/> Provided By Company
								<br>
