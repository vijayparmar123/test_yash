				...
				<table width=100% border=1>
					<tbody>
						...
						<tr>
							...
							<td colspan='2' align='right'><span><?php echo $data["loan_payment"]; ?></span></td>
						</tr>
						<tr>
							<td align='center'>3</td>
							<td colspan='5'>Other Deductions</td>
							<td colspan='2' align='right'><span><?php echo $data["others"]; ?></span></td>
						</tr>
						<tr>
	...
	<div class="form-row">
		<div class="col-md-6 pull-right">
				...
				<div class="col-md-2 pull-right">						 
					<a href="../printsalaryvoucher/<?php echo $data["slip_id"]; ?>" class="btn btn-info	" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div> 
			</div>
	</div>
</div>
