...
<div class="block">
		...
		<div class="content">
			<div class="col-md-12 filter-form">
				...
				<div class="form-row">
					...
					<div class="col-md-3">
						<input name="issue_date" required="true" id="date" class="form-control  date validate[required] datep" value="<?php echo date("d/m/Y"); ?>">
					</div>
		...
		<div class="col-md-6" >
			  <div class="block block-drop-shadow">
					...
					<input type="text" id="bonus" name="extra_bonus" class="inputs">
					</div> 
					<div class="footer" style="background: #D99594;">
						<p class="filter-title"><b>Total</b></p>
						<input type="hidden" id="bonusvalue1" name="total_bonus" value="">
						 <p class="heads"><b><span  id="bonusvalue" name="extra_bonus"><?php echo sprintf("%.2f",$tax); ?></b></p></span></b><span id="rss"></span></p> 
					</div>
                </div>    
...
<script>
	$(document).ready(function()
	{
		 ...
		 $("#bonus").change(function(){
		 	var bonus = $(this).val();
		 	var tax = $('#tax').html();
			var total = parseFloat(bonus) + parseFloat(tax);
			...
			$('#rs').html("  (Rs)");
		 	$('#bonusvalue').html(final_amount);
			$('#bonusvalue1').val(final_amount);
		 });
