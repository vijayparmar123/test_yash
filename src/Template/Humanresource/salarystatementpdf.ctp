<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="payslip_approval.pdf"');
		...
		$mpdf->SetTitle('Payslip Approval List');	
		...
		unset($rows[0]);
		$header = array("Employee No","Employee Name","Designation","Employee at","CTC(Month)(Rs.)","Total Earning(Rs.)","Prof. Tax","EPF","ESI","Loan Repayment/ Advance","Mobile Bill Recovery","TDS","Other Deductions","Net Pay");
