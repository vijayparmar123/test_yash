...
<div class="col-md-10" >
                ...
                <div class="block block-fill-white">
					<div class="head bg-default bg-light-rtl">
						...
						<a href="<?php echo $this->ERPfunction->action_link('Vendor','index');?>" class="btn btn-success"><span class="icon-plus"></span> Back</a>
						</div>
					</div>
                    <div class="header">
                    ...
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10"><input type="text" name="vendor_name" value="<?php echo $vendor_name;?>" class="form-control validate[required]"/></div>
                        </div>
						<div class="form-row">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><input type="text" name="pancard_no" value="<?php echo $pancard_no;?>" class="form-control"/></div>
                        
                            <div class="col-md-2">VAT/TIN No</div>
                            <div class="col-md-4">
								 <div class="col-md-4"><input type="text" name="vat_tin_no" value="<?php echo $vat_tin_no;?>" class="form-control"/></div>
							</div>
                         </div>
						 <div class="form-row">
                             <div class="col-md-2">Service Tax No</div>
                            <div class="col-md-4"><input type="text" name="service_tax_no" value="<?php echo $service_tax_no;?>" class="form-control"/></div>
                        
                            <div class="col-md-2">CST No</div>
                            <div class="col-md-4">
								 <div class="col-md-4"><input type="text" name="cst_no" value="<?php echo $cst_no;?>" class="form-control"/></div>
							</div>
                         </div>
						 <div class="form-row">
                             <div class="col-md-2">GST No</div>
                            <div class="col-md-4"><input type="text" name="gst_no" value="<?php echo $gst_no;?>" class="form-control"/></div>
                        
                            <div class="col-md-2">A/C No</div>
                            <div class="col-md-4">
								 <div class="col-md-4"><input type="text" name="ac_no" value="<?php echo $ac_no;?>" class="form-control"/></div>
							</div>
                         </div>
						 <div class="form-row">
                            ...
                            <div class="col-md-4">
								 <div class="col-md-4"><input type="text" name="ifsc_code" value="<?php echo $ifsc_code;?>" class="form-control"/></div>
							</div>
                         </div>
						 <div class="form-row">
