...
<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="vendor_list.pdf"');
		...
		unset($rows[0]);
		$header =array("Vendor ID","Vedor Name","Contact No(1)","Contact No(2)","Address","Email ID");
