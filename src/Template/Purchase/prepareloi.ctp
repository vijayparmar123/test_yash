...
jQuery(document).ready(function() {
	jQuery("body").on("click","#prepareloi",function(){
	
		
			if(confirm("Are you sure,you want to Prepare Letter of Intent?"))
			{
				if(confirm("Are you sure,you want to Prepare Letter of Intent?"))
				{
					return true;
	...
	jQuery("#add_newrow").click(function(){
		...
		jQuery.ajax({
					headers: {
                     ...
                     data : {row_id:row_id,row_type:row_type,project_id:project_id},
                     success: function (response)
                        {	
  ...
  jQuery("body").on("blur", "#loi_date", function(event){ 
	  jQuery(".material_id").select2("val", "");
	  jQuery(".hsn_code").val("");
	  jQuery(".brand_id").select2("val", "");
	  jQuery(".m_code").html("");
...
<div class="col-md-12" >		
					...
					<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><input type="text" name="loi_date" id="loi_date" 
		...
		<td></td>
						...
						<!--<p> <u>Select Billing Address Location.</u>
							...
							<p>14) Payment will be done <input type="text" name="payment_days" id="payment_days" value="" style="width:60px;float:none;display: inline;" /> days after date of delivery on site or bill submission which ever is later.</p>
							</div>
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Remarks/Note</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><button type="submit" id="prepareloi" class="btn btn-primary"><?php echo $button_text;?></button></div>
                        </div>
					</div>
				<?php $this->Form->end(); ?>
			</div>
