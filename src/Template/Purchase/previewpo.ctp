...
<div class="col-md-12 ">
	...
	?>	
		...
		<table width="100%" border="1" >
			<tbody>
				<tr align="center">
				<td colspan="13"><?php echo $this->ERPfunction->viewheader_po($erp_po_details['po_date']);?></td>
				</tr>
				...
				<tr>
					...
					<td colspan="12" ><?php echo $this->ERPfunction->get_projectaddress($erp_po_details['project_id']);
	...
	<div class="row" style="font-style:italic;color:gray;">	
							...
							<div class="col-md-12 ">
								...
								<div class="col-md-3"> 
									 <?php 
										foreach($previw_list as $retrive_material)
										{
											if($retrive_material['first_approved_by'])
											{
												echo "Varified by:".$this->ERPfunction->get_user_name($retrive_material['first_approved_by']);
												break;
											}
										}
									?>
								...
								<div class="col-md-3 pull-right">						 
								  <a href="<?php echo $this->request->base;?>/Inventory/printporecord/<?php echo $erp_po_details["po_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
	</div>
