...
$taxes_duties = (($erp_loi_details['taxes_duties'] == 1)?"checked":"");
$loading_transport = (($erp_loi_details['loading_transport'] == 1)?"checked":"");
$extra_transport = isset($erp_loi_details['extra_transport'])?$erp_loi_details['extra_transport']:"";
$unloading = (($erp_loi_details['unloading'] == 1)?"checked":"");
$warranty = isset($erp_loi_details['warranty'])?$erp_loi_details['warranty']:"";
$bill_address = isset($erp_loi_details['bill_address'])?$erp_loi_details['bill_address']:"";
$bill_mode = isset($erp_loi_details['bill_mode'])?$erp_loi_details['bill_mode']:"";
$gstno = ($erp_loi_details['gstno']?$erp_loi_details['gstno']:"");
$vatno = ($erp_loi_details['vatno']?$erp_loi_details['vatno']:"");
$cstno = ($erp_loi_details['cstno']?$erp_loi_details['cstno']:"");
$payment_days = ($erp_loi_details['payment_days']?$erp_loi_details['payment_days']:"");
$remarks = ($erp_loi_details['remarks']?$erp_loi_details['remarks']:"");
$delivery_date = ($erp_loi_details["delivery_date"] != NULL)?date("d-m-Y",strtotime($erp_loi_details["delivery_date"])):date("d")+1 . "-".date("m")."-".date("Y");
//$po_type = $erp_loi_details["po_purchase_type"];
// var_dump($po_type);die;
...
jQuery(document).ready(function() {
	jQuery("body").on("click","#editloi",function(){
	
		
			if(confirm("Are you sure,you want to Edit this LOI?"))
			{
				if(confirm("Are you sure,you want to Edit this LOI?"))
				{
					return true;
	   ...
	   var curr_data = {	 						 					
	 	 ...
	 	 jQuery.ajax({
                ...
                success: function(response){					
					...
					jQuery('#loi_no').val(json_obj['po_no']);						
	...
	jQuery("#add_newrow").click(function(){
		...
		jQuery.ajax({
					...
					'X-CSRF-Token': csrfToken
                     ...
                     type: 'POST',
                     url: '<?php echo Router::url(["controller" => "Ajaxfunction","action" => "addnewrowloi"]);?>',
  ...
  jQuery('body').on('click','.del_parent',function(){
		...
		if(detail_id)
		{
	 	 ...
	 	 jQuery.ajax({
                ...
                type:"POST",
                url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'deleteloidetail'));?>",
                data:curr_data,
                async:false,
                success: function(response){
...
<div class="col-md-12" >			
                <div class="block block-fill-white">
					...
					<input type="hidden" name="user_action" class="form-control" value="<?php echo $user_action;?>"/>	
					 ...
					 <div class="content controls">
						<div class="form-row">
                            ...
                            <div class="col-md-4"><input type="text" name="project_code" id="project_code" value="<?php echo $this->ERPfunction->get_projectcode($erp_loi_details['project_id']);?>"
                            ...
                            <div class="col-md-4">
								...
								<?php 
									...
									{
										// echo '<option value="'.$retrive_data['project_id'].'" '.(($erp_loi_details['project_id'] == $retrive_data['project_id'])?'selected':'').'>'.
										// $retrive_data['project_code'].' '.$retrive_data['project_name'].'</option>';
										if($erp_loi_details['project_id'] == $retrive_data['project_id'])
										{
											echo '<option value="'.$retrive_data['project_id'].'" '.(($erp_loi_details['project_id'] == $retrive_data['project_id'])?'selected':'').'>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-10">
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" class="bill_mode" value="gujarat" <?php echo ($erp_loi_details['bill_mode'] == 'gujarat')?'checked':''; ?> /> Gujarat
									</label>
                                </div>
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="mp" class="bill_mode" <?php echo ($erp_loi_details['bill_mode'] == 'mp')?'checked':''; ?> />Madhya Pradesh</label>
                                </div>
								<div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="maharastra" class="bill_mode" <?php echo ($erp_loi_details['bill_mode'] == 'maharastra')?'checked':''; ?> />Maharastra</label>
                                </div>
								<div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="haryana" class="bill_mode" <?php echo ($erp_loi_details['bill_mode'] == 'haryana')?'checked':''; ?> />Haryana</label>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<select class="select2"  required="true" name="usage_name" style="width:100%;" id="usage">
									<option value="for_self" <?php echo ($erp_loi_details['usage_name'] == 'for_self')?'selected':''; ?> >For Self Use</Option>							
									<option value="for_agency" <?php echo ($erp_loi_details['usage_name'] == 'for_agency')?'selected':''; ?>>For Agency</Option>									
								</select>
							</div>
							
							<div id="agency_div" style="display:<?php echo ($erp_loi_details['usage_name'] == 'for_agency')?'':'none'; ?>"> 
                            ...
                            <div class="col-md-4">
								<select class="select2 agency_id" style="width: 100%;" name="agency_id" id="agency_id">
									...
									<?php 
										...
										{
											$selected = ($retrive_data['id'] == $erp_loi_details['agency_id'])?'selected':'';
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">							
								<input type="text" name="loi_no" id="loi_no" value="<?php echo $erp_loi_details["loi_no"];?>" class="form-control" value=""/>
							</div>
                        
                            <div class="col-md-1">Date:</div>
                            <div class="col-md-2"><input type="text" readonly="true" name="loi_date" id="loi_date" 
							value="<?php echo date('d-m-Y',strtotime($erp_loi_details["loi_date"]));?>" class="form-control" value=""/></div>
							 <div class="col-md-1">Time:</div>
                            <div class="col-md-2"><input type="text" name="loi_time" id="loi_time" 
							value="<?php echo $erp_loi_details["loi_time"];?>" class="form-control" value=""/></div>
                        </div>
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								...
								{echo '<option value="'.$retrive_data['user_id'].'" '.(($erp_loi_details["vendor_userid"] == $retrive_data["user_id"])?"selected":"").'>'.
                            ...
                            <div class="col-md-4">
								<input type="text" name="vendor_id" id="vendor_id" class="form-control" value="<?php echo $erp_loi_details["vendor_id"]; ?>" />
							</div>
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Vendor Addresss:</div>
                            <div class="col-md-8">
								<input type="text" name="vendor_address"  id="vendor_address" class="form-control" value="<?php echo $erp_loi_details["vendor_address"]; ?>"/>
							</div>
                        </div>
						<div class="form-row">						
                            <div class="col-md-2">PAN No:</div>
							<div class="col-md-4">
								<input type="text" name="custom_pan" id="custom_pan" class="form-control" value="<?php echo $this->ERPfunction->get_vendor_detail($erp_loi_details['vendor_userid'],'pancard_no');?>" />
							</div>
							
                            <div class="col-md-2">GST No:</div>
							<div class="col-md-4">
								<input type="text" name="custom_gst" id="custom_gst" value="<?php echo $this->ERPfunction->get_vendor_detail($erp_loi_details['vendor_userid'],'gst_no'); ?>" class="form-control"/>
							</div>
						</div>
						<div class="form-row">						
                            <div class="col-md-2">Contact No: (1)</div>
							<div class="col-md-4">
								<input type="text" name="contact_no1" id="ven_contact_no1" class="form-control" value="<?php echo $this->ERPfunction->get_vendor_contact($erp_loi_details["vendor_userid"],"one");?>"/>
							</div>
							
                            <div class="col-md-2">Contact No: (2)</div>
							<div class="col-md-4">
								<input type="text" name="contact_no2" id="ven_contact_no2" value="<?php echo $this->ERPfunction->get_vendor_contact($erp_loi_details["vendor_userid"],"two");?>" class="form-control"/>
							</div>
						</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-10">
								...
								value="<?php echo $erp_loi_details["vendor_email"]; ?>"/>
							</div>
                        </div>
						 ...
						 <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="radiobox-inline">
                                    <label><input type="radio"  name="delivery_type" class="delivery_type" value="direct" <?php echo ($erp_loi_details['delivery_type'] == 'direct')?'checked':''; ?>/> Direct Delivery</label>
                                </div>
                                <div class="radiobox-inline">
                                    <label><input type="radio" name="delivery_type" class="delivery_type" value="via" 
									<?php echo ($erp_loi_details['delivery_type'] == 'via')?'checked':''; ?>/> Delivery Via</label>
                                </div>                                                              
                            </div>
							
							<div id="delivery_project_div" style="display:<?php echo ($erp_loi_details['delivery_type'] == 'via')?'':'none'; ?>">
                            ...
                            <div class="col-md-4">
								...
								<?php 
									foreach($projects as $retrive_data)
									{
										$selected = ($retrive_data['project_id']==$erp_loi_details['delivery_project'] )?'selected':'';
						...
						<div class="form-row">
                            ...
                            <div class="col-md-8">
								<input type="text" name="vendor_delivery_address" id="vendor_delivery_address" class="form-control" value="<?php echo $this->ERPfunction->get_projectaddress(($erp_loi_details['delivery_type'] == 'via')?$erp_loi_details["delivery_project"]:$erp_loi_details["project_id"]); ?>"/>
								<input type="hidden" name="project_address" id="project_address" class="form-control" value="<?php echo $this->ERPfunction->get_projectaddress($erp_loi_details["project_id"]); ?>"/>
							</div>
                        </div>
						<div class="form-row">
						<!--
                            ...
                            <div class="col-md-4">
								<input class="form-control" style="width: 100%;" name="" id="curre_pr_id" value="<?php echo $erp_loi_details["vendor_id"]; ?>">							
														</div> -->
                        
                            <div class="col-md-2">Contact No: (1)</div>
							<div class="col-md-4">
								<input type="text" name="contact_no1" id="contact_no1" class="form-control" value="<?php echo $erp_loi_details["contact_no1"]; ?>"/>
							</div>
							<div class="col-md-2">Contact No: (2)</div>
							<div class="col-md-4">
								<input type="text" name="contact_no2" id="contact_no2" value="<?php echo $erp_loi_details["contact_no2"]; ?>" class="form-control"/>
							</div>
                        </div>
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<select class="select2"  required="true"   style="width: 100%;" name="payment_method" id="payment_method">
									...
									<option value="cash" <?php echo ($erp_loi_details["payment_method"] == "cash")?"selected":"";?>>Cash</Option>
									<option value="cheque" <?php echo ($erp_loi_details["payment_method"] == "cheque")?"selected":"";?>>Cheque</Option>							
								</select>
							</div>
					...
					<!--	<div class="form-row" id="radiogroup">                           
                            ...
                            <div class="col-md-1">
								<input name="other_tax" type="radio" class="othertax" value="CST" sid="a" <?php //echo ($erp_loi_details["other_tax"]=="CST")?"checked":"";?>>CST
								<br>
								<input name="other_tax" type="radio" class="othertax" value="VAT" sid="a" <?php //echo ($erp_loi_details["other_tax"]=="VAT")?"checked":"";?>>VAT
							</div>
							<div class="col-md-1 text-right" id="do-left">
								<input name="other_tax" type="radio" class="othertax" value="GST" sid="a" <?php //echo ($erp_loi_details["other_tax"]=="GST")?"checked":"";?>>GST
								<br>
								<input name="other_tax" type="radio" class="othertax" value="" sid="other" <?php //echo ($erp_loi_details["other_tax"]!="CST" && $erp_loi_details["other_tax"]!="VAT" && $erp_loi_details["other_tax"]!="GST")?"checked":"";?>>Other								
							</div>
							<div class="col-md-2 text-right">
								<br>
								<input id="other_text" class="form-control" 
								<?php //echo ($erp_loi_details["other_tax"]!="CST" && $erp_loi_details["other_tax"]!="VAT" && $erp_loi_details["other_tax"]!="GST")?'style="display:block"':'style="display:none"';?>
								value="<?php //echo $erp_loi_details["other_tax"];?>">
							</div>
						</div> -->
						...
						<div class="form-row" style="padding:15px 0 0 0;">
							...
							<!--<p id="show_loading" <?php echo ($erp_loi_details['loading_transport'] != 1)?:"style='display:none;'"?>>
							...
							<p>2) Material/item supplied must meet IS specifications; on failing to match with it or will found unsatisfactory after some days of delivery; supplier/party has to replace that free of cost and this LOI will be considered as void.
							</p>
							...
							<p>5) If you will not revert back within 48 hrs, this LOI will be considered as accepted by you.</p>
							...
							<p>8) The final PO will be released subject to product approval from concerned Client / PMC / Consultant for that you need to support our staff in getting aprroval.</p>
							...
							<p id="mp_address" <?php echo ($bill_mode == "mp")?'':'style="display:none;"';?>><strong>Billing Address:</strong><?php echo $this->ERPfunction->getmpbilladdress($erp_loi_details["po_date"]); ?></p>
							...
							<p><strong>PAN No.:</strong><span id="pan_no"><?php echo $this->ERPfunction->getstatepanno($bill_mode,$erp_loi_details["po_date"]); ?></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<!--<p>9) <?php //echo $this->ERPfunction->getconditionofpowo($erp_loi_details["po_date"],$bill_mode); ?></p>-->
							<p>9) After getting approval of your product from concerned Client / PMC / Consultant, you have to take PO before manufacturing and/or dispatch. No material to be dispatched without PO.</p>
							<p>10) If your product rejected, this LOI will be considered as void.</p>
							<p>11) If any other product approved or required in future you need to supply it with same commercial terms.</p>
							<p>12) Material will be procured in a staggered manner as per the site requirement.</p>
							<p>13) YASHNAND ENGINEERS AND CONTRACTORS PVT. LTD. has right to cancel LOI any time without any prior notice.</p>
							<p>14) Payment will be done <input type="text" name="payment_days" id="payment_days" value="<?php echo $payment_days;?>" style="width:60px;float:none;display: inline;" /> days after date of delivery on site or bill submission which ever is later.</p>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-10">
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="mail_check" class="mail_check" value="1" id="enabled_mail" <?php echo ($erp_loi_details['mail_check'] == 1)?'checked':''; ?>/> Enable</label>
                                </div>
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="mail_check" value="0" class="mail_check" id="disabled_mail" <?php echo ($erp_loi_details['mail_check'] == 0)?'checked':''; ?> />Disable</label>
                                </div>
								<div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="mail_check" value="2" class="mail_check" id="enableddeputymanager_mail" <?php echo ($erp_loi_details['mail_check'] == 2)?'checked':''; ?>/>Enable + Dy. Manager (Ele.)</label>
                                </div>
                            </div>
						</div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><button type="submit" id="editloi" class="btn btn-primary"><?php echo $button_text;?></button></div>
                        </div>
					</div>
				<?php $this->Form->end(); ?>
				<input type="hidden" value="<?php echo $loi_id;?>" id="loiid">
			</div>
			</div>
<?php }?>
         </div>