...
<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="loi_records.pdf"');
		...
		unset($rows[0]);
		$header = array("LOI No","LOI Date","Project Name","Vendor Name","Material Name","Make/Source","Quantity","Unit","Final Rate","Amount");
