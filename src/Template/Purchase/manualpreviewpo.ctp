...
<div class="col-md-12">
		...
		<table width="100%" border="1" >
			...
			<!--	<tr>
				...
				<tr>
					...
					<td valign="bottom" align="center" height="120" colspan="8"><font size="4"><strong>For YashNand Engineers & Contractors</strong></font><br><br> 
					<?php 
						foreach($previw_list as $retrive_material)
						{
	...
	<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-12 pull-right">
								...
								<div class="col-md-2">						 
								  <a href="../printmanualporecord/<?php echo $erp_po_details["po_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
	</div>
