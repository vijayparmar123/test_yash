...
?>
			...
			?>
			<input type="hidden" name="action_name" value="manualapprovepo">
			...
			<table id="pr_list"  class="table table-bordered table-striped table-hover">
					...
					<tr>
						...
						<th colspan="9" style="padding:0;">
							<table class='table-bordered' style='width:100%;'>
								...
								<th>Edit/View</th>
								<?php
								if($this->ERPfunction->retrive_accessrights($role,'approve1manualpoalert')==1)
								{
								?>
								<th>Approve</th>
								<?php
								...
								?>
								<?php
								if($this->ERPfunction->retrive_accessrights($role,'approve2manualpoalert')==1)
								{
								?>
								<th>Approve</th>
								<?php
				...
				<tbody>
					...
					echo $this->ERPfunction->get_manualpo_alerts($selected_project);
					?>
