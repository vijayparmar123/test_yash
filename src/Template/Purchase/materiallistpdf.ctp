...
<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="agency_list.pdf"');
		...
		unset($rows[0]);
		$header = array("Material Code","Material Group","Material Sub-Group","Material Name","Material Description","Unit","Project","Consume Type");
