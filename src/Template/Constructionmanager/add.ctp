...
$role=isset($user_data['role'])?$user_data['role']:'constructionmanager';
?>
...
<div class="col-md-10" >
                ...
                <div class="block block-fill-white">
					<div class="header">
						...
						<a href="<?php echo $this->ERPfunction->action_link('Constructionmanager','index');?>" class="btn btn-default">Back</a></h1>
