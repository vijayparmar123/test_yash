                ...
                <div class="block block-fill-white">
					...
					<input type="hidden" name="user_action" class="form-control" value="<?php ?>"/>	
					 ...
					 <div class="content controls">
						<div class="form-row">
                            <div class="col-md-2">Name of Expense Head<span class="require-field">*</span> </div>
                            <div class="col-md-4"><input type="text" name="expense_head_name" id="expense_head_name" value="<?php echo $head_detail['expence_head_name']; ?>"
							class="form-control validate[required]"  /></div>
							
                            
                        </div>
						<div class="form-row">
                            <div class="col-md-2">Type of Expenses under above Head<span class="require-field">*</span></div>
                            <div class="col-md-10">
								<textarea name="expense_type" id="expense_type" class="form-control validate[required]"><?php echo $head_detail['expence_type']; ?></textarea>
							</div>
                        </div>
					...
					<!-- <div class="form-row">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><button type="submit" class="btn btn-primary">Edit</button></div>
                        </div>
					</div>
