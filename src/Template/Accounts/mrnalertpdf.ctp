<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="mrnalert_list.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>MRN ALERT LIST</b></td>");
		...
		unset($rows[0]);
		$header = array("M.R.N. No","Date","Time","Vendor ID","Vendor Name","Material Code","Material Name","Make/Source","Return Qyt.","Unit");
