		...
		// $mpdf->WriteHTML("<tr>");
			...
			{	
				...
				$mpdf->WriteHTML("<tr>");
					...
					$mpdf->WriteHTML("<td align='center' colspan='5'>{$retrive_material['reason']}</td>");
			...
			$i=0;
						...
						foreach($detail_list as $retrive_material){
							if(++$i === $numItems) 
							{
				 $mpdf->WriteHTML("<td colspan='6'>{$retrive_material['total_word']}</td>");
							}
						}
			...
			// $mpdf->WriteHTML("</tr>");
			 ...
			 $mpdf->WriteHTML("<tr>");
				$mpdf->WriteHTML("<td align='center' colspan='3'><br><br><br><br>");
