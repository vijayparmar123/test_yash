			...
			<tbody>
				...
				<?php 
					foreach($previw_list as $retrive_material){
						if($retrive_material['material_id'] != 0)
							{
								...
								$static_unit = $this->ERPfunction->get_items_units($retrive_material['material_id']);
							...
							else
							{
								...
								$static_unit = $retrive_material['static_unit'];
				...
				<tr>
					<!-- <td align="center" colspan="4"><h3><strong> Quantity Varified By </strong></h3>
						 <?php
					...
					<td align="center" colspan="4"><h3><strong> Approved By </strong></h3>
						<?php
						$i=0;
						$numItems = count($previw_list->toArray());
						foreach($previw_list as $retrive_material){
							if(++$i === $numItems) 
							{
								echo $this->ERPfunction->get_user_name($retrive_material['approved_by']); 
							}
						}
						?>
					</td>
				...
				<tr>
					<td align="center" colspan="4"> (Store In-charge/Weighbridge In-charge)</td>
					<!-- <td align="center"  colspan="3"> (Material Manager)</td> -->
					<td align="center"  colspan="4"> (Construction Manager)</td>
				</tr>
		...
		<div class="col-md-6 pull-left">
			...
			<div class="col-md-6 pull-right">
				...
				<div class="col-md-2 pull-right">						 
					<a href="../printaccountgrn/<?php echo $erp_grn_details["grn_id"];?>" class="btn btn-info	" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div> 
			</div>
		</div> 
	<?php  
