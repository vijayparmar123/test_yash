<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="advance.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>ADVANCE LIST</b></td>");
		...
		unset($rows[0]);
		$header = array("Project Name","Transfer Date","Agency ID","Agency's Name","Advance(Rs.)","TDS(Rs.)","Net Paid Amount(Rs.)","Transfer Mode");
