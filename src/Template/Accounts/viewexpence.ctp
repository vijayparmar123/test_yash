                ...
                <div class="block block-fill-white">
					...
					<input type="hidden" name="user_action" class="form-control" value="<?php ?>"/>	
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
							...
							class="form-control validate[required]" value="<?php echo $expence_list['voucher_no']; ?>" readonly="true"/></div>
							<div class="col-md-2 text-right">Date</div>
                            <div class="col-md-4"><input type="text" name="pr_date" id="pr_date" 
							readonly="true" class="form-control" value="<?php echo $this->ERPfunction->get_date($expence_list['date']); ?>"/></div>
                        </div>
						
						<div class="form-row">
                            <div class="col-md-2">Expence Head<span class="require-field">*</span></div>
                            <div class="col-md-10">
								<select class="select2"  disabled="disabled"   style="width: 100%;" name="expence_head" id="expence_head">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4"><input type="text" name="given_to" readonly="true" id="given_to" value="<?php echo $expence_list['given_to']; ?>"
							class="form-control validate[required]"/></div>
							<div class="col-md-2">Payment *</div>
                            <div class="col-md-4">
								<select class="select2"  disabled="disabled"   style="width: 100%;" name="payment_type" id="payment_type">
							...
							class="form-control validate[required]"/></td>
								...
								?>
									<tr id="row_id_0">
										...
										<td>
											<input type="text" name="expense[description][]" readonly="true"  value="<?php echo $retrive_data['expence_description']; ?>" class="form-control"/>
										</td>
										<td>
										<input type="text" name="expense[amount][]" readonly="true" id="amount_value_<?php echo $i - 1; ?>"  value="<?php echo $retrive_data['expence_amount']; ?>" class="form-control validate[required] amount_txt" />
										<input type="hidden" name="expense[id][]" readonly="true" id="id"  value="<?php echo $retrive_data['detail_id']; ?>" class="form-control validate[required] id" />
										</td>
					...
					<div class="col-md-7 pull-right">
						...
						<div class="col-md-4">
						  ...
						  <div class="col-md-4">						 
						  <a href="../printaccountexpence/<?php echo $expence_list['id'];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
						</div>
					</div>
				</div>
					</div>
