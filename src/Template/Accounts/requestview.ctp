	  ...
	  var material_id  = jQuery(this).val() ;
	   ...
	   var curr_data = {	 						 					
	 	 ...
	 	 jQuery.ajax({
                ...
                type:"POST",
                url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'getagencylist'));?>",
                data:curr_data,
                async:false,
                success: function(response){					
					var json_obj = jQuery.parseJSON(response);					
...
<div class="col-md-10" >
                ...
                <div class="block block-fill-white">
					<div class="head bg-default bg-light-rtl">
						...
						<a href="<?php echo $this->ERPfunction->action_link('Accounts',$back);?>" class="btn btn-success"><span class="icon-arrow-left"></span> Back</a>
						</div>
					</div>
					...
					<input type="hidden" name="user_action" class="form-control" value="<?php ?>"/>	
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<input type="text" name="prno" id="prno" disabled="disabled"  class="form-control" value="<?php echo $request_list['advance_req_no']; ?>"/>
							</div>
                        
                            <div class="col-md-1 text-right">Date</div>
                            <div class="col-md-2"><input type="text" name="pr_date" disabled="disabled" id="pr_date" 
                            ...
                            <div class="col-md-2"><input type="text" name="pr_time" disabled="disabled" id="pr_time" 
					...
					<!-- <div class="form-row">
                            ...
                            <table class="table table-bordered">
								...
								?>
									<tr id="row_id_<?php echo $i; ?>">
										<td><span id="material_code_<?php echo $i; ?>"><?php if(isset($req_data['agency_id'])){ echo $this->ERPfunction->get_vendor_code($req_data['agency_id']); } ?></span></td>
										<td>
											<select class="select2 material_id" style="width: 100%;" disabled="disabled" name="agency[agency_id][]" id="material_id_<?php echo $i; ?>" data-id="<?php echo $i; ?>">
										...
										<td>
											<input type="text" name="agency[labors][]" id="" disabled="disabled" value="<?php if(isset($req_data['labor'])) echo $req_data['labor']; ?>" class="form-control"/>
										</td>
										<td>
										<input type="text" name="agency[advance_rs][]" id="" disabled="disabled" value="<?php if(isset($req_data['advance_rs'])) echo $req_data['advance_rs']; ?>" class="form-control"/>
										<input type="hidden" name="agency[id][]" id="" disabled="disabled" value="<?php echo $req_data['id']; ?>" class="form-control"/>
										</td>
						...
						<br><br><br>
						  <div class="col-md-4">						 
						  <a href="<?php echo $this->request->base; ?>/Accounts/printadvance/<?php echo $request_id;?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
						</div>
					</div>
					</div>
