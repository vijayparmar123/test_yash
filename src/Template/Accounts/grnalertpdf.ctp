<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="grnalert_list.pdf"');
		...
		$mpdf->WriteHTML("<td align=left><b>GRN ALERT LIST</b></td>");
		...
		unset($rows[0]);
		$header = array("G.R.N No","Date","Vendor Name","Challan No.","Material Name","Make/ Source","Actual Qty.","Unit");
