                ...
                <div class="block block-fill-white">
                            ...
                            <table class="table table-bordered">
								...
								?>
									<tr id="row_id_<?php echo $i; ?>">
										...
										<td style="width:40%">
											<input type="text" name="debit[reason][]" readonly="true" value="<?php echo $retrive_data['reason']; ?>" class="form-control validate[required]"/>
										</td>
					...
					<div class="col-md-7 pull-right">
						<br><br><br>
						  ...
						  <div class="col-md-4">						 
						  <a href="../printdebit/<?php echo $debit_list['debit_id'];?>" class="btn btn-primary" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
						</div>
					</div>
				</div>
