...
jQuery(document).ready(function() {
	jQuery('#requirement_date').datepicker({
		dateFormat: "dd-mm-yy",
		changeMonth: true,
	    changeYear: true,
	    yearRange:'-65:+0',
...
<div class="modal-header" >
	...
	<h4 class="modal-title"> Edit Asset Booking</h4>
</div>
...
<form name="medicinecat_form" action="issueasset" method="post" class="form-horizontal transferform">
		...
		<div class="form-row">
			...
			<div class="col-sm-6">
				<input id="requirement_date" class="form-control datep text-input" type="text" 
				value="<?php echo $this->ERPfunction->get_date($history_data["requirment_date"]); ?>" name="requirement_date">
			</div>			
		</div>
		<div class="form-row">			
			<div class="col-sm-4">
				<input type="button" value="Update Booking" name="booking_aaset" class="btn btn-primary" id="update-booking-history"/>
			</div>
		</div>
  	</form>
</div>
