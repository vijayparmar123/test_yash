...
<div class="modal-header" >
	...
	<h4 class="modal-title"> <?php echo "Add Qty. Checked By"; ?></h4>
</div>
...
<div class="controls">
	...
	<form name="add_subgroup_form" action="" method="post" class="form-horizontal" id="subgroup_form">
		<div class="form-row">
			...
			<div class="col-md-6">
				<input name="qty-checked-by" id="qty-checked-by" value="" class="validate[required] form-control"/>
			</div>
		</div>
		<div class="form-row">
			<div class="col-sm-4">
				<input type="button" value="Add" name="save-qty-checked-by" class="btn btn-primary" id="save-qty-checked-by"/>
			</div>
		</div>
	</form>
	
	<table border='1px' class="table-bordered" id="qty-checked-listing">
	<thead>
		<tr>
			<th>Name</th>
		</tr>
