		...
		$mpdf->WriteHTML("<tr>");
			...
			$mpdf->WriteHTML("<tr>");
				$mpdf->WriteHTML("<td><b>P.O. No:</b></td>
					<td colspan='2' >{$this->ERPfunction->get_po_records($erp_grn_details['po_id'])["po_no"]}</td>");
			...
			$mpdf->WriteHTML("<tr>");
				...
				$mpdf->WriteHTML("<td colspan='2' style='border-right:1 solid;'>Unloading (Rs.):</td><td colspan='1'>{$erp_grn_details['unloading']}</td>");
			$mpdf->WriteHTML("</tr>");
			...
			$mpdf->WriteHTML("<tr>");
			/* $mpdf->WriteHTML("<td align='center' colspan='2'><br><br><br>");
				...
				$mpdf->WriteHTML("<td align='center' colspan='4' style='border-right:1 solid;'><br><br><br>");
			...
			$mpdf->WriteHTML("<tr>");
				...
				$mpdf->WriteHTML("<td align='center'  colspan='4'><br><br> (Material Manager)</td>");
				$mpdf->WriteHTML("<td align='center' colspan='4' style='border-right:1 solid;'><br><br> (Construction Manager)</td>");
			$mpdf->WriteHTML("</tr>");
