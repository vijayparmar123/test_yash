<tr id="row_id_<?php echo $row_id;?>">
	...
	<td>
		...
		<input type="text" placeholder="Description Here" class="desc_textfield" name="material[detail_description][]" value="" id="detail_description_<?php echo $row_id ?>" data-id="<?php echo $row_id;?>" style="display:none;">
	</td>
	<!-- <td> 
