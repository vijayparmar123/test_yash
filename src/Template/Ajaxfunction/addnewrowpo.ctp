...
<tr id="row_id_<?php echo $row_id;?>" class='row_id' data-id="<?php echo $row_id;?>">
		...
		{
		?>
			<td style="display:none;"><span class="m_code" id="material_code_<?php echo $row_id;?>"></span>
		...
		?>
			...
			<span id="material_code_<?php echo $row_id;?>"><?php echo $this->ERPfunction->generate_auto_id_prepare_po($last_code); ?></span>
			<input type="hidden" value="" name="material[m_code][]" class="text_data
		...
		?>
			...
			<a href="javascript:void(0)" class="btn btn-primary add_textfield" onClick="insertRow(<?php echo $row_id; ?>)" id="textfield_<?php echo $row_id; ?>" data-id = "<?php echo $row_id; ?>" value="textfield">Textfield</a>
