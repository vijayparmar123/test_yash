<tr id="row_id_<?php echo $row_id;?>">
	...
	<td><input type="text" name="material[quantity][]" row-id="<?php echo $row_id;?>" id="quantity_<?php echo $row_id;?>" value="" class="form-control validate[required] transfer_qty"/></td>
	<td><span id="unit_name_<?php echo $row_id;?>"></span></td>
	<td><input type="text" name="material[intimated_by][]" id = "intimated_by_<?php echo $row_id;?>" value="" class="form-control"/></td>
