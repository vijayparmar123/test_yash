...
<div class="modal-header" >
	...
	<h4 class="modal-title"> Join Work Sub-group</h4>
</div>
<div class="modal-body clearfix">
	<div class="controls">
		<?php echo $this->Form->Create('join_form',['url'=>['controller'=>'contract', 'action'=>'joinworksubgroup'],'class'=>'form_horizontal formsize','method'=>'post','id'=>'join_form','enctype'=>'multipart/form-data']);?>
			<div class="form-row">
				...
				<div class="col-md-6">
					<select class="select2" name="material_id" id="material_id" required="true" style='width:100%'>
						<option value="">--Select Work Sub-group--</option>
						<?php						
