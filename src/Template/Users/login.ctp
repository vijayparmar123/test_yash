...
<section id="wrapper" class="login-register">
  <div class="login-box">
	...
	'method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'login']]);?>
      ...
      <img src="<?php echo $this->request->base .'/img/logo/ERP_Banner.png'; ?>" class="" />
		...
		<div class="form-group">
			<div class="col-md-10 col-sm-10 col-xs-12" style="padding-left: 30px;    padding-top: 20px;">
				<!----------- Mobilewebs local ------- -->
				<div class="g-recaptcha gc-reset"  data-sitekey="6LcPQ78bAAAAAAdl07ufbqJSp0grO11Q9akBCNLN"></div>
  ...
  <span class="cst-footer">Copyright &COPY; Yashnand 2021. All rights reserved.</span>
</section>