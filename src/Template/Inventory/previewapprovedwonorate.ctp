		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td align="center" colspan="11"><strong>Work / Item</strong></td>
					<!--<td rowspan="2" ><strong>Amount <br>(Inclusive All)</strong></td>-->
				</tr>
				<tr>
					<td colspan="5"><strong>Work Head</strong></td>
				...
				<tr>
					...
					<td colspan="5"><?php echo $this->ERPfunction->get_work_head_title($retrive_material['work_head']);?></td>
					<td colspan="3"><?php echo $retrive_material['material_name'];?></td>
...
<!-- remarks 2 start -->
	...
	<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-7 pull-right">
								<br><br><br>
								<div class="col-md-2">						 
								  <a href="../printapprovedworecordnorate/<?php echo $wo_data["wo_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
