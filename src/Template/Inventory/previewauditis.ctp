	...
	?>	
				...
				<tr>
					...
					<td colspan="8" ><?php 
						...
						if(isset($is_asset[1]))
						{
							...
							echo $this->ERPfunction->get_vendor_name($erp_is_details['agency_name']); 
						} ?>
					</td>
				</tr>
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
				...
				<div class="col-md-2 pull-right">						 
					<a href="../../prinauditis/<?php echo $erp_is_details["audit_is_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div> 
				<?php
				}else
				{
