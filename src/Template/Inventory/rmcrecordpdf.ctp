...
<?php 
	...
	error_reporting(0);
		...
		header('Content-Disposition: inline; filename="rmc_records.pdf"');
		...
		unset($rows[0]);
		$header = array("Date","RMC. L. No","Asset Name","Order By","Concrete Grade","Qty. Supplied(Cum)","Usage","Start Time","End Time");
