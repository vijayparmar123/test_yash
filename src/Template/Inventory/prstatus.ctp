						...
						<tr>
							...
							<th colspan="9" style="padding:0;">
								<table class='table-bordered' style='width:100%;'>
									...
									<?php
									if($this->ERPfunction->retrive_accessrights($role,'previewpr')==1)
									{
									?>
									<th>View</th>
									<?php } ?>
						...
						// {		
							...
							?>
								<tr class="rmv_<?php echo $i;?>">								
									...
									<td colspan="9">
									<?php 
										$materials_data = $this->ERPfunction->get_pr_staus_materials($retrive_data["erp_inventory_pr_material"],$retrive_data["pr_id"],$i,$project);
