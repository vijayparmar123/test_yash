		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
			...
			<div class="col-md-6 pull-right">
				...
				<div class="col-md-2 pull-right">						 
					<a href="../printauditgrnrecord/<?php echo $erp_grn_details["audit_id"];?>" class="btn btn-info	" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div> 
