<?php 
	...
	error_reporting(0);
		...
		$mpdf->SetTitle('Approved Issue Slip List');	
		$mpdf->WriteHTML('<table width=100%>');
		$mpdf->WriteHTML("<tr align=left>");
		$mpdf->WriteHTML("<td align=left><b>Approved Issue Slip List</b></td>");
		...
		unset($rows[0]);
		$header = array("#","Project Name","I.S. No","Agency or Asset Name","Date","Material Name","Quantity","Unit","Name of Foreman");
