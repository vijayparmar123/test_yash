	...
	$mpdf->WriteHTML("</tr>");
			...
			$mpdf->WriteHTML("<tr>");
				...
				$mpdf->WriteHTML("<td rowspan='2' ><strong>Name of Foreman</strong></td>
									<td rowspan='2' style='border-right:0;'><strong>Time of Issue</strong></td>");
			$mpdf->WriteHTML("</tr>");
			...
			$mpdf->WriteHTML("<td style='border-right:0;' colspan='4' align='center'><h3><strong> Approved By </strong></h3><br><br><br>&nbsp;{$this->ERPfunction->get_user_name($data['approve_by'])}&nbsp;</td>");
			$mpdf->WriteHTML("</tr>");
