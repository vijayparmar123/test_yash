		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<th rowspan="2" colspan="2" class="text-center">Unit</th>	
				...
				<tr class="text-center">
					...
					<td colspan="2"><?php echo $retrive_material['unit'];?></td>
		...
		<div class="col-md-6">	
						...
						?>						
							<div class="col-md-2 pull-left">
								<br><br><br>
								<div class="col-md-2">						 
								  <a href="../planningpreviewapprovedwonorate/<?php echo $wo_id;?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> View <?php echo $i; ?></a>
								</div> 
							</div>
