			...
			$('#old_look').on( 'click', function () {
				...
				<table class="table table-bordered stockledger_table">
					...
					<tr>
						...
						<td></td>											
						<td></td>											
						<td><?php echo $old_stock = (isset($opening_stock))?intval($opening_stock["quantity"]):"0";?>
					...
					{	
						...
						$rows[] = array("","Opening Stock","",$old_stock,"","",$old_stock,"");
						...
						<tr> 
							...
							<?php
							$val1 = "";
							if($retrive_data["type"] == 'is' || $retrive_data["type"] == 'rbn' || $retrive_data["type"] == 'debit' || $retrive_data["type"] == 'debit_party')
							{
