...
<div class="col-md-12">
	...
	<div id="scrolling-div">
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					<td align="center" colspan="12"><strong>Material / Item</strong></td>
				</tr>
				<tr>
					<td colspan="3"><strong>Description</strong></td>
					<td colspan="3"><strong>Make / Source</strong></td>
				...
				?>
				<tr>
					<td colspan="3"><center>(<?php echo is_numeric($retrive_material['material_id'])?$this->ERPfunction->get_materialitemcode($retrive_material['material_id']):$retrive_material['m_code'];?>)<br><?php echo is_numeric($retrive_material['material_id'])?$this->ERPfunction->get_material_title($retrive_material['material_id']):$retrive_material['material_id'];?></center></td>
					
					<td colspan="3"><?php echo is_numeric($retrive_material['brand_id'])?$this->ERPfunction->get_brandname($retrive_material['brand_id']):$retrive_material['brand_id'];?></td>
					
					<td colspan="3"><?php echo $retrive_material['quantity'];?></td>
					
					<td colspan="3"><?php echo is_numeric($retrive_material['material_id'])?$this->ERPfunction->get_items_units($retrive_material['material_id']):$retrive_material['static_unit'];?></td>
			...
			<!--	<tr>
				...
				<tr>
					<td valign="bottom"  align="center"  height="120" colspan="3"> 					
	...
	<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-12 pull-right">
								...
								<div class="col-md-2">						 
								  <a href="../printporecordnorate2inventory/<?php echo $erp_po_details["po_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
	</div>
