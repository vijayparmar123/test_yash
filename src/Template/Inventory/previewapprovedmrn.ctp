			...
			<div class="row" style="font-style:italic;color:gray;">							
							<div class="col-md-7 pull-right">
								...
								<div class="col-md-2">						 
								  ...
								  <a href="<?php echo $this->request->base ."/inventory/printapprovedmrn/".$erp_mrn_details["mrn_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
								</div> 
							</div>
						</div>
