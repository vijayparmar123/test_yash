	...
	?>	    
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td colspan="8"><?php echo $this->ERPfunction->get_agency_name($erp_rbn_details['agency_name']); ?> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" colspan="4"><h3><strong> Approved By </strong></h3>
						<?php
						if($erp_rbn_details['approved_by']){
							echo $this->ERPfunction->get_user_name($erp_rbn_details['approved_by']); 
						}
						?>
					</td>
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
				...
				<div class="col-md-1 pull-right">			 
					  <a href="<?php echo $this->request->base ."/inventory/printrbn/".$erp_rbn_details["rbn_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div>
