	...
	?>	
		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td rowspan="2" ><strong>Time of Issue</strong></td>
				...
				<tr>
					...
					<td align="center" colspan="4"><h3><strong> Approved By </strong></h3>
						<?php 
						if($erp_is_details['approve_by']){
							echo $this->ERPfunction->get_user_name($erp_is_details['approve_by']); 
						}
						?>
					</td>
					<!--
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
				...
				<div class="col-md-1 pull-right">			 
					  <a href="../printis/<?php echo $erp_is_details["is_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div>
