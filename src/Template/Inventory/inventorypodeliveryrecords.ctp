		...
		<div class="block">
			<div class="head bg-default bg-light-rtl">
				...
				<div class="pull-right">
					<a href="<?php echo $this->ERPfunction->action_link('inventory',$back);?>" class="btn btn-success"><span class="icon-arrow-left"></span> Back</a>
				</div>
			</div>
		<div class="content ">
		<script>
	...
	var table = jQuery('#po_list').DataTable({
		...
		"ajax": {
			headers: {
				...
				url:"<?php echo Router::url(array('controller'=>'Ajaxfunction','action'=>'inventorypodeliveryrecords'));?>",
				"data": function ( d ) {
											d.myKey = "myValue";
