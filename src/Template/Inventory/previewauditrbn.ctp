	...
	?>	    
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
				...
				<div class="col-md-1 pull-right">			 
					  <a href="<?php echo $this->request->base ."/inventory/printauditrbn/".$erp_rbn_details["audit_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div>
