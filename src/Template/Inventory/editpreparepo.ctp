...
<div class="col-md-12" >			
                <div class="block block-fill-white">
					<div class="head bg-default bg-light-rtl">
						...
						<a href="<?php echo $this->ERPfunction->action_link('Inventory','approvepo');?>" class="btn btn-success"><span class="icon-arrow-left"></span> Back</a>
						</div>
					</div>
					 ...
					 <div class="content controls">
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								...
								<input type="hidden" name="project_id" value="<?php echo $erp_po_details['project_id']; ?>">
							</div>
                        </div>						
						<div class="form-row">
                            ...
                            <div class="col-md-10">
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" class="bill_mode" id="gujarat" value="gujarat" <?php echo ($erp_po_details['bill_mode'] == 'gujarat')?'checked':''; ?> /> Gujarat
									</label>
                                </div>
                                <div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="mp" id="mp" class="bill_mode" <?php echo ($erp_po_details['bill_mode'] == 'mp')?'checked':''; ?> />Madhya Pradesh</label>
                                </div>
								<div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="maharastra" id="maharastra" class="bill_mode" <?php echo ($erp_po_details['bill_mode'] == 'maharastra')?'checked':''; ?> />Maharastra</label>
                                </div>
								<div class="radiobox-inline" style="padding:0 50px;">
                                    <label><input type="radio" name="bill_mode" value="haryana" id="haryana" class="bill_mode" <?php echo ($erp_po_details['bill_mode'] == 'haryana')?'checked':''; ?> />Haryana</label>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<input type="text" readonly="true" name="mode_of_gst" id="mode_of_gst" value="<?php echo $erp_po_details['mode_of_gst']; ?>" class="form-control"/>
							</div>
