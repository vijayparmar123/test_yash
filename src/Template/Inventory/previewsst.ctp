...
<div class="col-md-10 ">
	...
	?>	
			...
			<tbody>
				...
				<tr>
					...
					<td align="center" colspan="4"><h3><strong> Approved By </strong></h3>
						<?php
						if($erp_sst_details['approved_by']){
							echo $this->ERPfunction->get_user_name($erp_sst_details['approved_by']); 
						}
						?>
					</td>
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">				<div class="col-md-6 pull-right">
				...
				<div class="col-md-2">						 
				 <a href="../printsst/<?php echo $erp_sst_details["sst_id"];?>" class="btn btn-default" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
				</div> 
			</div>
		</div>
	<?php  
