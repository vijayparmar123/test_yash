<?php 
	...
	error_reporting(0);
		...
		$mpdf->SetTitle('Approved G.R.N List');	
		$mpdf->WriteHTML('<table width=100%>');
		$mpdf->WriteHTML("<tr align=left>");
		$mpdf->WriteHTML("<td align=left><b>Approved G.R.N. List</b></td>");
		...
		unset($rows[0]);
		$header = array("#","Project Name","G.R.N No","Date","Time","Vendor Name","Challan No","Material Name","Make/Source","Material Group","Vendor/Royalty\"\s Qty./Weight","Actual Qty./Weight","Diff.(+/-)","Unit","Mode of Purchase","Mode of Payment");
