                ...
                <div class="block block-fill-white">					
					...
					<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
                            <div class="col-md-2">Agency / Asset Name*</div>
                            <div class="col-md-10">
								<?php  echo $this->Form->select("agency_name",$agency_list,["default"=>[$rbndata['agency_name']],"class"=>"select2 asst_list","style"=>"width:100%","id"=>"","required"=>true]);?>
							</div>  							
                        </div>						
                            ...
                            <table class="table table-bordered">
								...
								foreach($items as $materials)
								{
									...
									<tr id="row_id_<?php echo $i;?>">
										...
										<input type="hidden" name="material[detail_id][]" value="<?php echo $material["audit_detail_id"];?>">
									</tr>
									<?php $i++;
									 } 
									} ?>
