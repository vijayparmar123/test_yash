...
<div class="col-md-10 ">
	...
	?>	
		...
		<table width="100%" border="1" >
			<tbody>
				<tr align="center"><td colspan="11"><?php echo $this->ERPfunction->viewheader($pr_material['pr_date']);?></td></tr>
			...
			<!--	<tr>
				...
				<tr>
					...
					<td colspan="4"> <?php echo $pr_material['contact_no2']; ?></td>
				</tr>
				<tr>
		...
		<div class="row" style="font-style:italic;color:gray;padding-top:15px;">
			...
			<!-- <div class="col-md-4">				 -->
				...
				-->
				<!-- <div class="col-md-3">
					<form action="../potoxls/<?php //echo $pr_material["pr_id"];?>" method="post"><input type="submit" value="Export to XLS" class="btn"></form>
				</div> -->
				<!-- Attachment Showing code -->
				<div class="col-md-6 add_field">
					<h2>Attachment</h2>
					<?php 
						// debug($pr_material);die;
				...
				<div class="col-md-1">
				<?php
					if(isset($previw_list[0]))
					{
						if($previw_list[0]['purchase_first_approve'])
						{
							
				?>
				<p>Checked By : <?php echo $this->ERPfunction->get_user_name($previw_list[0]['purchase_first_approveby']); ?></p>
				<p>Date : <?php echo date("d-m-Y",strtotime($previw_list[0]['purchase_first_approve_date'])); ?></p>
				<?php } } ?>
			</div>
				<div class="col-md-3 pull-right">			 
					<a href="../printprapproved/<?php echo $pr_material["pr_id"];?>" class="btn btn-info" id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
					<a href='../../purchase/potoxls/<?php echo $pr_material['pr_id']; ?>' class='btn btn-info'>Export</a>
				</div>				
			<!-- </div> -->
		</div>
	<?php  
