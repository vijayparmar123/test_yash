<?php 
	...
	error_reporting(0);
		...
		$mpdf->SetTitle('Approved M.R.N List');	
		$mpdf->WriteHTML('<table width=100%>');
		$mpdf->WriteHTML("<tr align=left>");
		$mpdf->WriteHTML("<td align=left><b>Approved M.R.N. List</b></td>");
		...
		unset($rows[0]);
		$header = array("#","Project Name","M.R.N No","Date","Time","Vendor Name","Material Name","Make/Source","Returned Quantity","Unit");
