					...
					{	
						...
						<tr> 
							...
							if($consume_value == 0 || $consume_value == 3)
							{
								...
								echo $t_previous_balance = $this->ERPfunction->get_symbolic_stock_balance($retrive_data["type"],$t_previous_balance,$retrive_data["quantity"]);
								...
								echo $this->ERPfunction->get_stock_balance($retrive_data["type"],$previous_balance,$retrive_data["quantity"]);
						...
						<!-- <td><?php //echo ($retrive_data['damaged_qty']!= 0)?$retrive_data['damaged_qty']:"";?></td> -->
							...
							echo $previous_balance = $this->ERPfunction->get_stock_balance($retrive_data["type"],$previous_balance,$retrive_data["quantity"]);
