					...
					<?php echo $this->Form->Create('form1',['id'=>'user_form','class'=>'form_horizontal formsize','method'=>'post','enctype'=>'multipart/form-data'],['url'=>['action'=>'']]);?>	
					 ...
					 <div class="content controls">
						...
						<div class="form-row">
							...
							value="<?php echo $row->rmc_no;?>" readonly="true" class="form-control" readonly="true"/></div>
							
                            <div class="col-md-2 text-right">Date</div>
                            <div class="col-md-4"><input type="text" name="rmc_date" readonly="true" id="rmc_date" 
						...
						<div class="form-row">
                            ...
                            <div class="col-md-4">
								<select class="select2" required="true" disabled style="width: 100%;" name="asset_id" id="asset_id">
						...
						<div class="form-row">
                            ...
                            <div class="col-md-10">
							<select class="select2" required="true" disabled style="width: 100%;" name="agency_name" id="agency_name">
                        ...
                        <div class="form-row">
							...
							<div class="col-md-4"><input type="text" name="operator_name" readonly="true" id="operator_name" class="form-control validate[required]" value="<?php echo $row->operators_name; ?>"/></div>
							<div class="col-md-2">Order By<span class="require-field">*</span> </div>
							<div class="col-md-4"><input type="text" name="order_by" id="order_by" value="<?php echo $row->order_by; ?>" readonly="true" class="form-control validate[required]"/></div>
						</div>
						<div class="form-row">
						<div class="col-md-2">Usage</div>
						<div class="col-md-4"><textarea name="usage" readonly="true" id="usage" class="form-control"><?php echo $row->rmc_usage; ?></textarea></div>
						</div>
						
						<div class="form-row">
							<div class="col-md-2">Concrete Grade *</div>
                            <div class="col-md-4">
								<select class="select2" required="true" disabled style="width: 100%;" name="concrete_grade" id="concrete_grade">
							...
							<div class="col-md-4"><input type="text" name="total_quantity" id="total_quantity" readonly="true" value="<?php echo $row->total_quantity_supplied; ?>" class="form-control validate[required,custom[number]]"/></div>
                        </div>
						
						<div class="form-row">
						<div class="col-md-2">Start Time<span class="require-field">*</span> </div>
						<div class="col-md-4"><input type="text" name="start_time" id="start_time" value="<?php echo $row->start_time; ?>" readonly="true" class="form-control validate[required]"/></div>
						<div class="col-md-2">End Time<span class="require-field">*</span> </div>
						<div class="col-md-4"><input type="text" readonly="true" name="end_time" id="end_time" value="<?php echo $row->end_time; ?>" class="form-control validate[required]"/></div>
						</div>
