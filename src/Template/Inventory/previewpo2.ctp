                ...
                <table width="100%" border="1">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php
					if($erp_po_details['usage_name'] == 'for_agency'){
				?>
                        <tr>
				...
				?>
					...
					<td colspan="12" ><?php //echo $erp_po_details['other_tax'];?></td>
                        ...
                        <tr>
                            ...
                            <td rowspan="2" align="center" style="max-width:40px;"><strong>Final Rate<br>(Inclusive All)</strong></td>
                        </tr>
                        <tr>
                            <td colspan="5" align="center" style="min-width:445px;"><strong>Description</strong></td>
                            <!--<td><strong>HSN Code</strong></td>-->
                            <td colspan="1" align="center" style="width:10px;"><strong>Make / Source</strong></td>
                            <td><strong>Quantity</strong></td>
                            <td style="max-width:10px;"><strong>Unit</strong></td>
                            <td style="max-width:20px;"><strong>Unit Rate
                                    <!--(including Loading, Unloading, Transport and All Taxes)--><br> (Rs.)</strong>
                            </td>
                            <td align="center" style="max-width:40px;"><strong>Discount<br>(%)</strong></td>
                            <!-- <td>CGST<br>(%)</td>
                            <td>SGST<br>(%)</td>
                            <td>IGST<br>(%)</td> -->
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <center>
                                    (<?php echo is_numeric($retrive_material['material_id'])?$this->ERPfunction->get_materialitemcode($retrive_material['material_id']):$retrive_material['m_code'];?>)<br>
                                    <?php echo is_numeric($retrive_material['material_id'])?$this->ERPfunction->get_material_title($retrive_material['material_id']):$retrive_material['material_id'];?>
					...
					$total_amount += $retrive_material['amount'];
                        ...
                        <tr>
                        <tr>
                            <td align="right"><input type="checkbox" name="vehicle" value="Bike"
                                    <?php echo ($erp_po_details["taxes_duties"]) ? "checked" : "";?> disabled></td>
                            <td colspan="11"><strong>All Taxes & Duties</strong></td>
                        </tr>
                        <tr>
                            <td align="right"><input type="checkbox" name="vehicle" value="Bike"
                                    <?php echo ($erp_po_details["loading_transport"]) ? "checked" : "";?> disabled></td>
                            <td colspan="11"><strong>Loading & Transportation - F. O. R. at Place of Delivery</strong>
                            </td>
                        </tr>
                        <tr>
                            <td align="right"><input type="checkbox" name="vehicle" value="Bike"
                                    <?php echo ($erp_po_details["unloading"]) ? "checked" : "";?> disabled></td>
                            <td colspan="11"><strong>Unloading</strong></td>
                        </tr>
                        <tr>
                            <td align="right"><input type="checkbox" name="vehicle" value="Bike"
                                    <?php echo ($erp_po_details["warranty"] != "") ? "checked" : "";?> disabled></td>
				...
				<tr>-->
                        ...
                        <tr>
                           ...
                           <!--  <td valign="bottom" align="center" height="120" colspan="4">
        						...
        						// }
        					?><br>
                                <font size="4"><strong>Verified by</strong></font>
                            </td> -->
                            <td valign="bottom" align="center" height="120" colspan="6">
                                <font size="4">
	...
	?>
            <div class="row" style="font-style:italic;color:gray;">
				...
				?>
                    ...
                    <div class="col-md-3">
                        <?php echo "Last Edited By: {$last_edit_by}"; echo "<br>";
                         $lastEditBy = isset($erp_po_details['last_edit'])?$this->ERPfunction->get_formate_date($erp_po_details['last_edit']):'NA';
                    ...
                    <div class="col-md-3">
                        <?php 		 
					foreach($previw_list as $retrive_material) {// if($retrive_material['verified']) {
				...
				?>
                    ...
                    <div class="col-md-3">
                        <a href="../printporecord2/<?php echo $erp_po_details["po_id"];?>" class="btn btn-default"
                            id="print_this" target="_blank"><i class="icon-print"></i> Print</a>
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <?php 		 
					foreach($previw_list as $retrive_material) {	// if($retrive_material['first_approved']) {
