 ...
 */
class CeoController extends AppController
{
	...
	public function add($user_id=Null)
    {
		...
		if(isset($user_id))
		{
			...
			$this->set('form_header','Edit C.E.O');
			$this->set('button_text','Update C.E.O');
		...
		else
		{
			...
			$this->set('form_header','Add C.E.O');
			$this->set('button_text','Add C.E.O');
		}
		...
		{	$this->set('user_data',$this->request->data);
			...
			{
				$this->Flash->success(__('CEO Insert Successfully', null), 
							'default', 
							array('class' => 'success'));
				}
				}
			}
			$this->redirect(array("controller" => "Ceo","action" => "index"));		
		}		
    }
