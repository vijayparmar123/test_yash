 ...
 */
class ConstructionmanagerController extends AppController
{
    ...
    public function index()
    {
		...
		$user_list = $users_table->find()->where(array('role'=>'constructionmanager'));
	...
	public function add($user_id=Null)
    {
		...
		if(isset($user_id))
		{
			...
			$this->set('form_header','Edit Construction Manager');
			$this->set('button_text','Update Construction Manager');
		...
		else
		{
			...
			$this->set('form_header','Add Construction Manager');
			$this->set('button_text','Add Construction Manager');
		}
		...
		{	$this->set('user_data',$this->request->data);
			...
			else
			{
				...
				else
				{
					...
					{
						$this->Flash->success(__('Construction Manager Insert Successfully', null), 
									'default', 
									array('class' => 'success'));
			...
			$this->redirect(array("controller" => "Constructionmanager","action" => "index"));		
		}		
    }
