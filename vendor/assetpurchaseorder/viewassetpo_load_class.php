		...
		for ( $i=0, $ien=count($data) ; $i<$ien ; $i++ ) {
			...
			for ( $j=0, $jen=count($columns) ; $j<$jen ; $j++ ) {
				...
				else if($j== 11)
				{
					...
					if(self::retrive_accessrights($role,'viewassetporecords')==1)
					{
						$html .= "<a href='previewassetpo/{$uid}' target='_blank' class='btn btn-primary btn-clean'><i class='icon-eye-open'></i> View</a>";
					}
									
					if(self::retrive_accessrights($role,'cancelassetpo')==1)
								{
						$html .= "<a href='cancelassetpo/{$uid}' class='btn btn-danger btn-clean'><i class='icon-pencil'></i> Delete</a>";
					}
